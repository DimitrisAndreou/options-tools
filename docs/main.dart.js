...
pr(a,b){var s,r,q,p,o,n,m,l,k,j=a.$1(b),i=A.j([],t.eQ)
...
break $label0$0}k=j
break $label0$0}return A.pq(m,1/0,b,k,j)},
...
a1=a3.ch=1+Math.max(a6.gaR(),0)/Math.max(-a6.gaD(),0)
a3.dx=Math.max(a6.gaR(),0)
a2=J.ee(a6.av(a6.gaR())).a
a3.CW=a2
a3.cx=a2/a5
a3.cy=1+a6.dS(a5)/Math.max(-a6.gaD(),0)
a6=a5*a1
a3.db=a6
A.nc("Spot price="+A.e(a5)+", maxYield="+A.e(a1)+", equivalentHodlerSellPrice="+A.e(a6))
a1=new A.r(a8.a,1)
a2=b1.cv(r,a1)
a1=b1.bD(r,a1)
a3.dy=A.a_(A.j([a2,new A.r(a1.a,a1.b*-1)],j)).bd(r).b/a5
o=4
return b3.b=a3,1
case 4:o=2
break
...
a0=o.pop()
k=A.a0(a0)
A.rh("Failed while fetching url: ["+a1+"], error: "+A.e(k))
throw a0
s=6
break
case 3:s=2
