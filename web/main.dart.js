...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    IndexedIterable_IndexedIterable(source, start, $T) {
      ...
      return new A.IndexedIterable(source, start, $T._eval$1("IndexedIterable<0>"));
    },
    ...
    _Record_2_call_put: function _Record_2_call_put(t0, t1) {
      this._0 = t0;
      this._1 = t1;
    },
    ...
    Stream_toSet_closure: function Stream_toSet_closure(t0, t1) {
      this.$this = t0;
      this.result = t1;
    },
    Stream_toSet_closure0: function Stream_toSet_closure0(t0, t1) {
      this.future = t0;
      this.result = t1;
    },
    ...
    SplayTreeSet$(compare, isValidKey, $E) {
      ...
      return new A.SplayTreeSet(t1, isValidKey, $E._eval$1("SplayTreeSet<0>"));
    },
    ...
    DateTime$utc(year, month, day, hour) {
      var t1 = A.Primitives_valueFromDecomposedDate(year, month, day, hour, 0, 0, 0, 0, true);
      return new A.DateTime(t1 == null ? new A.DateTime$_internal_closure(year, month, day, hour, 0, 0, 0, 0).call$0() : t1, 0, true);
    },
    ...
    _Uri__Uri(path, queryParameters) {
      ...
      t1 = host == null;
      hasAuthority = !t1;
      path = A._Uri__makePath(path, 0, path == null ? 0 : path.length, _null, "", hasAuthority);
    ...
    FutureOfJSAnyToJSPromise_get_toJS(_this, $T) {
      var result,
        t1 = init.G.Promise,
        t2 = new A.FutureOfJSAnyToJSPromise_get_toJS_closure(_this);
      ...
      return A._asJSObject(new t1(result));
    },
    ...
    MemoryCache: function MemoryCache(t0) {
      this._cache$_cache = t0;
    },
    CacheItem: function CacheItem(t0, t1, t2) {
      this.expiry = t0;
      this.value = t1;
      this.$ti = t2;
    },
    _MergedPosition$(positions) {
      var t1 = new A._MergedPosition(A.HashMap_HashMap(type$.Asset, type$.double));
      t1._MergedPosition$1(positions);
      return t1;
    },
    Option$($name, contractLot, expiration, isCall, isPut, minSize, money, strike, underlying, venues) {
      if (isPut === isCall)
        A.throwExpression(A.ArgumentError$("Exactly one of these should be true: isPut: " + isPut + ", isCall: " + isCall, null));
      return new A.Option(money, strike, isPut, isCall, underlying, contractLot, minSize, expiration, $name, venues);
    },
    Venue: function Venue(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    ...
    Position_operator$index_closure: function Position_operator$index_closure(t0) {
      this.asset = t0;
    },
    ...
    _ScaledPosition: function _ScaledPosition(t0, t1) {
      this.position = t0;
      this.scale = t1;
    },
    _ScaledPosition_decompose_closure: function _ScaledPosition_decompose_closure(t0) {
      this.$this = t0;
    },
    _MergedPosition: function _MergedPosition(t0) {
      this._assetPositions = t0;
    },
    _MergedPosition_closure: function _MergedPosition_closure() {
    },
    _MergedPosition_closure0: function _MergedPosition_closure0(t0) {
      this.line = t0;
    },
    _MergedPosition_closure1: function _MergedPosition_closure1(t0) {
      this.line = t0;
    },
    Commodity: function Commodity(t0, t1) {
      this.name = t0;
      this._venues = t1;
    },
    Expirable: function Expirable() {
    },
    DatedFuture: function DatedFuture(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.underlying = t0;
      _.contractLot = t1;
      _.minSize = t2;
    ...
    Option: function Option(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9) {
      var _ = this;
      _.money = t0;
      _.strike = t1;
      _.isPut = t2;
    ...
    Deribit_fetchMarkets(coins, urlFetcher, errorListener, maxDTE, minDTE) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_Market),
        $async$returnValue, _i, coin, t2, t3, t4, t1, coinToResponse, $async$temp1, $async$temp2;
      var $async$Deribit_fetchMarkets = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = type$.dynamic;
              coinToResponse = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
              _i = 0;
            case 3:
              // for condition
              if (!(_i < 1)) {
              ...
              coin = coins[_i];
              $async$temp1 = coinToResponse;
              $async$temp2 = coin;
              $async$goto = 6;
              return A._asyncAwait(urlFetcher.fetch$1("https://www.deribit.com/api/v2/public/get_book_summary_by_currency?currency=" + coin), $async$Deribit_fetchMarkets);
            case 6:
              // returning from await.
            ...
            case 5:
              // after for
              t1 = coinToResponse.$ti;
              t2 = t1._eval$1("LinkedHashMapValuesIterable<2>");
              t3 = t2._eval$1("Iterable<ListedInstrument>(Iterable.E)")._as(new A.Deribit_fetchMarkets_closure());
              t4 = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.ListedInstrument);
              for (t1 = t2._eval$1("@<Iterable.E>")._bind$1(t1._eval$1("ListedInstrument")), t3 = new A.ExpandIterator(new A.LinkedHashMapValuesIterable(coinToResponse, t2).get$iterator(0), t3, B.C_EmptyIterator, t1._eval$1("ExpandIterator<1,2>")), t1 = t1._rest[1]; t3.moveNext$0();) {
                t2 = t3.__internal$_current;
                if (t2 == null)
                  t2 = t1._as(t2);
                t4.$indexSet(0, t2.instrument_name, t2);
              }
              t1 = new A.LinkedHashMapValuesIterable(t4, t4.$ti._eval$1("LinkedHashMapValuesIterable<2>")).followedBy$1(0, A.Deribit__implicitUsdInstruments(A._setArrayType(["USDC", "USDT"], type$.JSArray_String)));
              t2 = A._instanceType(t1);
              t3 = type$.NonNullsIterable_Market;
              t1 = A.List_List$_of(new A.NonNullsIterable(A.MappedIterable_MappedIterable(t1, t2._eval$1("Market?(Iterable.E)")._as(new A.Deribit_fetchMarkets_closure0(errorListener, minDTE, maxDTE)), t2._eval$1("Iterable.E"), type$.nullable_Market), t3), t3._eval$1("Iterable.E"));
              $async$returnValue = t1;
              // goto return
              $async$goto = 1;
              break;
      ...
      return A._asyncStartSync($async$Deribit_fetchMarkets, $async$completer);
    },
    Deribit__implicitUsdInstruments(stableCoins) {
      return new A._SyncStarIterable(A.Deribit__implicitUsdInstruments$body(stableCoins), type$._SyncStarIterable_ListedInstrument);
    },
    Deribit__implicitUsdInstruments$body($async$stableCoins) {
      return function() {
        var stableCoins = $async$stableCoins;
        var $async$goto = 0, $async$handler = 1, $async$errorStack = [], _i, stableCoin;
        return function $async$Deribit__implicitUsdInstruments($async$iterator, $async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$errorStack.push($async$result);
            $async$goto = $async$handler;
          }
          for (;;)
            switch ($async$goto) {
              ...
              case 2:
                ...
                stableCoin = stableCoins[_i];
                $async$goto = 5;
                return $async$iterator._async$_current = new A.ListedInstrument(stableCoin + "_USD", stableCoin, "USD", 1, null, null, null, 1, null, 1, null, null, null, null), 1;
              case 5:
                // after yield
              case 3:
                // for update
    ...
    ListedInstrumentDeribitUtils_toMarket(_this, errorListener, maxDTE, minDTE) {
      var _0_0, t1, underlying, makeMarket, t2, match, t3, t4, strat, dates, assetsList, datesList, t5, dd, t6, yy, expirationDate, dte, strikes, optionType, strikesList, strike, _null = null;
      if (_this.bid_price == null || _this.ask_price == null) {
        errorListener.call$2(_this, "No bid or no ask");
        return _null;
      }
      _0_0 = _this.base_currency;
      t1 = type$.Venue;
      underlying = new A.Commodity(_0_0, A.LinkedHashSet_LinkedHashSet$_literal([B.Venue_0], t1));
      makeMarket = new A.ListedInstrumentDeribitUtils_toMarket_makeMarket(new A.Commodity(_this.quote_currency, _null), _this);
      t2 = _this.instrument_name;
      match = $.$get$ListedInstrumentDeribitUtils__instrumentRegex().firstMatch$1(t2);
      if (match == null) {
        errorListener.call$2(_this, "UNPROCESSED: " + t2);
        return _null;
      }
      t3 = match._match;
      t4 = t3.length;
      ...
      strat = t3[2];
      if (strat != null) {
        errorListener.call$2(_this, "Ignoring strat: " + t2 + " (" + strat + ")");
        return _null;
      }
      if (3 >= t4)
        return A.ioore(t3, 3);
      dates = t3[3];
      if (dates == null)
        return makeMarket.call$1(underlying);
      t4 = type$.JSArray_String;
      assetsList = A._setArrayType(t3[1].split("_"), t4);
      if (assetsList.length > 2) {
        errorListener.call$2(_this, "Too many assets: " + A.S(assetsList));
        return _null;
      }
      datesList = A._setArrayType(dates.split("_"), t4);
      if (datesList.length !== 1) {
        errorListener.call$2(_this, "Multiple dates: " + A.S(datesList));
        return _null;
      }
      t4 = B.JSArray_methods.get$first(datesList);
      t4 = $.$get$ListedInstrumentDeribitUtils__dateRegex().firstMatch$1(t4)._match;
      if (1 >= t4.length)
        return A.ioore(t4, 1);
      t5 = t4[1];
      t5.toString;
      ...
      t4.toString;
      yy = A.int_parse(t4);
      t6 = $.$get$ListedInstrumentDeribitUtils__monthToNum().$index(0, t6);
      t6.toString;
      expirationDate = A.DateTime$utc(2000 + yy, t6, dd, 9).toLocal$0();
      dte = B.JSInt_methods._tdivFast$1(expirationDate.difference$1(new A.DateTime(Date.now(), 0, false))._duration, 864e8);
      if (dte < minDTE)
        return _null;
      if (dte > maxDTE)
        return _null;
      ...
      if (strikes == null) {
        if (optionType != null) {
          errorListener.call$2(_this, "A dated future with an option type?!");
          return _null;
        }
        return makeMarket.call$1(new A.DatedFuture(underlying, 1, 0.0001, expirationDate, t2, A.LinkedHashSet_LinkedHashSet$_literal([B.Venue_0], t1)));
      }
      strikesList = strikes.split("_");
      if (strikesList.length !== 1) {
        errorListener.call$2(_this, "An option with multiple strikes");
        return _null;
      }
      strike = A.double_parse(B.JSArray_methods.get$first(strikesList));
      if (optionType == null) {
        errorListener.call$2(_this, "An option without a type");
        return _null;
      }
      $label0$0: {
        if ("SOL" === _0_0) {
      ...
      t4 = _0_0 === "BTC" ? 0.1 : 1;
      return makeMarket.call$1(A.Option$(t2, t3, expirationDate, optionType === "C", optionType === "P", t4, new A.Commodity("USD", _null), strike, underlying, A.LinkedHashSet_LinkedHashSet$_literal([B.Venue_0], t1)));
    },
    Deribit_fetchMarkets_closure: function Deribit_fetchMarkets_closure() {
    },
    Deribit_fetchMarkets__closure: function Deribit_fetchMarkets__closure() {
    },
    Deribit_fetchMarkets__closure0: function Deribit_fetchMarkets__closure0() {
    },
    Deribit_fetchMarkets_closure0: function Deribit_fetchMarkets_closure0(t0, t1, t2) {
      this.errorListener = t0;
      this.minDTE = t1;
      this.maxDTE = t2;
    },
    ListedInstrumentDeribitUtils_toMarket_makeMarket: function ListedInstrumentDeribitUtils_toMarket_makeMarket(t0, t1) {
      this.money = t0;
      this._this = t1;
    },
    ListedInstrument: function ListedInstrument(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13) {
      var _ = this;
      _.instrument_name = t0;
      _.base_currency = t1;
      _.quote_currency = t2;
      _.mark_price = t3;
      _.estimated_delivery_price = t4;
      _.last = t5;
      _.low = t6;
      _.bid_price = t7;
      _.mid_price = t8;
      _.ask_price = t9;
      _.high = t10;
      _.underlying_index = t11;
      _.underlying_price = t12;
      _.price_change = t13;
    },
    UrlFetcher: function UrlFetcher(t0, t1) {
      this._url_fetcher$_cache = t0;
      this._url_fetcher$_duration = t1;
    },
    YFinance_openConnection(urlFetcher) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.YFinance),
        $async$returnValue, crumb, t1, headers;
      var $async$YFinance_openConnection = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = type$.String;
              headers = A.LinkedHashMap_LinkedHashMap$_literal(["User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36", "Accept", "*/*"], t1, t1);
              $async$goto = 3;
              return A._asyncAwait(urlFetcher.fetch$2$headers("https://fc.yahoo.com", headers), $async$YFinance_openConnection);
            case 3:
              // returning from await.
              $async$goto = 4;
              return A._asyncAwait(urlFetcher.fetch$2$headers("https://query2.finance.yahoo.com/v1/test/getcrumb", headers), $async$YFinance_openConnection);
            case 4:
              // returning from await.
              crumb = $async$result;
              if (B.JSString_methods.contains$1(crumb, "<html"))
                throw A.wrapException(A.Exception_Exception("Crumb request returned HTML (Session Rejected)"));
              $async$returnValue = new A.YFinance(headers, crumb);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$YFinance_openConnection, $async$completer);
    },
    YFinance: function YFinance(t0, t1) {
      this._headers = t0;
      this._crumb = t1;
    },
    MarketListExtension_whereUnderlyingIs(_this, underlying) {
      return J.where$1$ax(_this, new A.MarketListExtension_whereUnderlyingIs_closure(underlying));
    },
    MarketListExtension_coercedToMoney(_this, money, helper) {
      return _this.map$1$1(0, new A.MarketListExtension_coercedToMoney_closure(helper, money), type$.Market);
    },
    MarketListExtension_optionsWithStrikeInMoney(_this, strikeMoney) {
      var t1 = _this.$ti;
      return new A.WhereIterable(_this, t1._eval$1("bool(Iterable.E)")._as(new A.MarketListExtension_optionsWithStrikeInMoney_closure(strikeMoney)), t1._eval$1("WhereIterable<Iterable.E>"));
    },
    MarketListExtension_get_calls(_this) {
      return J.where$1$ax(_this, new A.MarketListExtension_get_calls_closure());
    },
    MarketListExtension_get_puts(_this) {
      return J.where$1$ax(_this, new A.MarketListExtension_get_puts_closure());
    },
    MarketListExtension_sortByExpiration(_this, order) {
      return A.MarketListExtension__sort(_this, new A.MarketListExtension_sortByExpiration_closure(), order, type$.DateTime);
    },
    MarketListExtension_sortByStrike(_this, order) {
      return A.MarketListExtension__sort(_this, new A.MarketListExtension_sortByStrike_closure(), order, type$.num);
    },
    MarketListExtension__sort(_this, keyExtractor, order, $T) {
      var t2,
        t1 = A.IndexedIterable_IndexedIterable(J.where$1$ax(_this, new A.MarketListExtension__sort_closure()), 0, type$.Market);
      t1 = A.List_List$_of(t1, A._instanceType(t1)._eval$1("Iterable.E"));
      t1 = A.List_List$_of(t1, type$.Record_2_int_and_Market);
      B.JSArray_methods.sort$1(t1, new A.MarketListExtension__sort_closure0(order, keyExtractor, $T));
      t2 = A._arrayInstanceType(t1);
      return new A.MappedListIterable(t1, t2._eval$1("Market(1)")._as(new A.MarketListExtension__sort_closure1()), t2._eval$1("MappedListIterable<1,Market>"));
    },
    MarketListExtension_groupByExpiration(_this, order) {
      var t1 = A.MarketListExtension_sortByExpiration(_this, order);
      return A.MarketListExtension__groupBy(t1, new A.MarketListExtension_groupByExpiration_closure(), type$.DateTime);
    },
    MarketListExtension_groupByStrike(_this, order) {
      var t1 = A.MarketListExtension_sortByStrike(_this, order);
      return A.MarketListExtension__groupBy(t1, new A.MarketListExtension_groupByStrike_closure(), type$.double);
    },
    MarketListExtension__groupBy(_this, keyExtractor, $T) {
      return A.IterableExtension_groupListsBy(J.where$1$ax(_this, new A.MarketListExtension__groupBy_closure()), new A.MarketListExtension__groupBy_closure0(keyExtractor, $T), type$.Market, $T);
    },
    MarketsMapExtension_mapValues(_this, fn, $T, $R) {
      return _this.map$2$1(0, new A.MarketsMapExtension_mapValues_closure(fn, $T, $R), $T, $R);
    },
    MarketListExtension_whereUnderlyingIs_closure: function MarketListExtension_whereUnderlyingIs_closure(t0) {
      this.underlying = t0;
    },
    MarketListExtension_coercedToMoney_closure: function MarketListExtension_coercedToMoney_closure(t0, t1) {
      this.helper = t0;
      this.money = t1;
    },
    MarketListExtension_optionsWithStrikeInMoney_closure: function MarketListExtension_optionsWithStrikeInMoney_closure(t0) {
      this.strikeMoney = t0;
    },
    MarketListExtension_get_calls_closure: function MarketListExtension_get_calls_closure() {
    },
    MarketListExtension_get_puts_closure: function MarketListExtension_get_puts_closure() {
    },
    MarketListExtension_sortByExpiration_closure: function MarketListExtension_sortByExpiration_closure() {
    },
    MarketListExtension_sortByStrike_closure: function MarketListExtension_sortByStrike_closure() {
    },
    MarketListExtension__sort_closure: function MarketListExtension__sort_closure() {
    },
    MarketListExtension__sort_closure0: function MarketListExtension__sort_closure0(t0, t1, t2) {
      this.order = t0;
      this.keyExtractor = t1;
      this.T = t2;
    },
    MarketListExtension__sort_closure1: function MarketListExtension__sort_closure1() {
    },
    MarketListExtension_groupByExpiration_closure: function MarketListExtension_groupByExpiration_closure() {
    },
    MarketListExtension_groupByStrike_closure: function MarketListExtension_groupByStrike_closure() {
    },
    MarketListExtension__groupBy_closure: function MarketListExtension__groupBy_closure() {
    },
    MarketListExtension__groupBy_closure0: function MarketListExtension__groupBy_closure0(t0, t1) {
      this.keyExtractor = t0;
      this.T = t1;
    },
    MarketsMapExtension_mapValues_closure: function MarketsMapExtension_mapValues_closure(t0, t1, t2) {
      this.fn = t0;
      this.T = t1;
      this.R = t2;
    },
    Market_Market$create(askPrice, asset, bidPrice, money) {
      return A._DirectMarket$(askPrice, 1 / 0, asset, bidPrice, 1 / 0, money);
    },
    _DirectMarket$(askPrice, askSize, asset, bidPrice, bidSize, money) {
      var t1 = new A._DirectMarket(asset, money, bidPrice, askPrice);
      if (bidPrice > askPrice)
        A.throwExpression(A.ArgumentError$(string$.Bid_pr + t1.toString$0(0), null));
      return t1;
    },
    _IdentityMarket$(asset) {
      return new A._IdentityMarket(asset, asset, 1, 1);
    },
    Market: function Market() {
    },
    Market_toString_closure: function Market_toString_closure() {
    },
    Market_toString_closure0: function Market_toString_closure0() {
    },
    _DirectMarket: function _DirectMarket(t0, t1, t2, t3) {
      var _ = this;
      _.asset = t0;
      _.money = t1;
      _.bidPrice = t2;
    ...
    _IdentityMarket: function _IdentityMarket(t0, t1, t2, t3) {
      var _ = this;
      _.asset = t0;
      _.money = t1;
      _.bidPrice = t2;
    ...
    _InverseMarket: function _InverseMarket(t0) {
      this._market = t0;
    },
    _SyntheticMarket: function _SyntheticMarket(t0, t1) {
      this._a2bMarket = t0;
      this._b2cMarket = t1;
    },
    Order: function Order(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    _RealMarketsOracle$(allMarkets) {
      var t1 = new A._RealMarketsOracle(allMarkets, A.HashMap_HashMap(type$.Asset, type$.Map_Asset_Market), A.HashMap_HashMap(type$.Record_2_Asset_and_Asset, type$.Market));
      t1._RealMarketsOracle$1(allMarkets);
      return t1;
    },
    Oracle: function Oracle() {
    },
    Oracle_markToMarket_closure: function Oracle_markToMarket_closure(t0, t1, t2) {
      this.$this = t0;
      this.money = t1;
      this.slippage = t2;
    },
    Oracle_intrinsicValue_closure: function Oracle_intrinsicValue_closure(t0) {
      this.$this = t0;
    },
    Oracle_intrinsicValue_closure0: function Oracle_intrinsicValue_closure0(t0, t1) {
      this.$this = t0;
      this.money = t1;
    },
    ArchOracle: function ArchOracle() {
    },
    _RealMarketsOracle: function _RealMarketsOracle(t0, t1, t2) {
      this.allMarkets = t0;
      this._markets = t1;
      this._cache = t2;
    },
    _RealMarketsOracle_marketFor_closure: function _RealMarketsOracle_marketFor_closure() {
    },
    SimulatedOracle: function SimulatedOracle(t0) {
      this._prices = t0;
    },
    PositionAnalyzer$(position, money, underlying) {
      var t1 = new A.PositionAnalyzer(position, underlying, money, A._setArrayType([], type$.JSArray__PnLSegment));
      t1.PositionAnalyzer$3$money$underlying(position, money, underlying);
      return t1;
    },
    PriceRange__mergeAdjacents(pnvs) {
      return pnvs.fold$1$2(0, A._setArrayType([], type$.JSArray_PriceRange), new A.PriceRange__mergeAdjacents_closure(), type$.List_PriceRange);
    },
    _PnLSegment$(delta, maxPrice, minPrice, valueAtMaxPrice, valueAtMinPrice) {
      if (!isFinite(minPrice))
        A.throwExpression(A.ArgumentError$("minPrice (" + A.S(minPrice) + ") must be finite", null));
      if (minPrice >= maxPrice)
        A.throwExpression(A.ArgumentError$("minPrice (" + A.S(minPrice) + ") >= maxPrice (" + A.S(maxPrice) + ")", null));
      return new A._PnLSegment(minPrice, maxPrice, valueAtMinPrice, valueAtMaxPrice, delta);
    },
    _PnLSegment__PnLSegment$open(priceToValue, minPrice) {
      var prevValue, prevPrice, i, nextPrice, nextValue, tentativeDelta, delta, _0_0, t1,
        valueAtMinPrice = priceToValue.call$1(minPrice),
        deltas = A._setArrayType([], type$.JSArray_double);
      for (prevValue = valueAtMinPrice, prevPrice = minPrice, i = 0; i < 5; ++i, prevValue = nextValue, prevPrice = nextPrice) {
        nextPrice = (prevPrice + 1) * 1.5;
        nextValue = priceToValue.call$1(nextPrice);
        B.JSArray_methods.add$1(deltas, (nextValue - prevValue) / (nextPrice - prevPrice));
      }
      B.JSArray_methods.sort$0(deltas);
      if (2 >= deltas.length)
        return A.ioore(deltas, 2);
      tentativeDelta = deltas[2];
      delta = Math.abs(tentativeDelta) < 1e-16 ? 0 : tentativeDelta;
      _0_0 = J.get$sign$in(delta);
      $label0$0: {
        if (1 === _0_0) {
          t1 = 1 / 0;
          break $label0$0;
      ...
      return A._PnLSegment$(delta, 1 / 0, minPrice, t1, valueAtMinPrice);
    },
    PositionAnalyzer: function PositionAnalyzer(t0, t1, t2, t3) {
      var _ = this;
      _.position = t0;
      _.underlying = t1;
      _.money = t2;
    ...
    PositionAnalyzer_priceToValue: function PositionAnalyzer_priceToValue(t0, t1) {
      this.$this = t0;
      this.oracle = t1;
    },
    PositionAnalyzer_minValue_closure: function PositionAnalyzer_minValue_closure() {
    },
    PositionAnalyzer_maxValue_closure: function PositionAnalyzer_maxValue_closure() {
    },
    PositionAnalyzer_whereValueIs_closure: function PositionAnalyzer_whereValueIs_closure(t0) {
      this.value = t0;
    },
    PriceRange: function PriceRange(t0, t1) {
      this.fromPrice = t0;
      this.toPrice = t1;
    },
    PriceRange__mergeAdjacents_closure: function PriceRange__mergeAdjacents_closure() {
    },
    _PnLSegment: function _PnLSegment(t0, t1, t2, t3, t4) {
      var _ = this;
      _.minPrice = t0;
      _.maxPrice = t1;
      _.___PnLSegment_valueAtMinPrice_F = t2;
      _.___PnLSegment_valueAtMaxPrice_F = t3;
      _.___PnLSegment_delta_F = t4;
    },
    AssetRenderer_forVenue(venue) {
      switch (venue.index) {
        case 0:
          return new A._DeribitAssetRenderer();
        case 1:
          return new A._OptionStratAssetRenderer();
      }
    },
    AssetRenderer_tryRenderFirst(asset) {
      var renderer, t1, t2, exception;
      for (t1 = asset.get$venues(), t1 = t1.get$iterator(t1); t1.moveNext$0();) {
        renderer = A.AssetRenderer_forVenue(t1.get$current());
        if (renderer != null)
          try {
            t2 = renderer.render$1(asset);
            return t2;
          } catch (exception) {
          }
      }
    ...
    PositionRenderer_forVenue(venue) {
      switch (venue.index) {
        case 1:
          return new A._OptionStratPositionRenderer();
        case 0:
          return null;
      }
    },
    PositionRenderer_tryRenderFirst(position) {
      var renderer, t2, t3, exception,
        t1 = J.expand$1$1$ax(position.decompose$0(), new A.PositionRenderer_tryRenderFirst_closure(), type$.Venue),
        venues = A.LinkedHashSet_LinkedHashSet$of(t1, t1.$ti._eval$1("Iterable.E"));
      for (t1 = A._LinkedHashSetIterator$(venues, venues._collection$_modifications, A._instanceType(venues)._precomputed1), t2 = t1.$ti._precomputed1; t1.moveNext$0();) {
        t3 = t1._collection$_current;
        renderer = A.PositionRenderer_forVenue(t3 == null ? t2._as(t3) : t3);
        if (renderer != null)
          try {
            t3 = renderer.render$1(position);
            return t3;
          } catch (exception) {
          }
      }
    ...
    _OptionStratAssetRenderer: function _OptionStratAssetRenderer() {
    },
    _DeribitAssetRenderer: function _DeribitAssetRenderer() {
    },
    PositionRenderer_tryRenderFirst_closure: function PositionRenderer_tryRenderFirst_closure() {
    },
    _OptionStratPositionRenderer: function _OptionStratPositionRenderer() {
    },
    CoveredCall_generateAll(allMarkets, money, slippage, underlying) {
      return new A._SyncStarIterable(A.CoveredCall_generateAll$body(allMarkets, money, slippage, underlying), type$._SyncStarIterable_CoveredCall);
    },
    CoveredCall_generateAll$body($async$allMarkets, $async$money, $async$slippage, $async$underlying) {
      return function() {
        var allMarkets = $async$allMarkets,
          money = $async$money,
          slippage = $async$slippage,
          underlying = $async$underlying;
        var $async$goto = 0, $async$handler = 1, $async$errorStack = [], $call, option, expiration, moneyProb, underlyingProb, e, t1, t2, t3, t4, t5, t6, t7, t8, t9, exception, t10, t11, t12, t13, t14, t15, t16, t17, t18, oracle, spotMarket, probs, $async$exception;
        return function $async$CoveredCall_generateAll($async$iterator, $async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$errorStack.push($async$result);
            $async$goto = $async$handler;
          }
          for (;;)
            switch ($async$goto) {
              case 0:
                // Function start
                oracle = A._RealMarketsOracle$(allMarkets);
                spotMarket = oracle.marketFor$2$asset$money(underlying, money);
                probs = A.Probabilities$(A.VerticalSpread_generateAll(allMarkets, money, slippage, underlying), money, underlying);
                t1 = A.MarketListExtension_sortByExpiration(A.MarketListExtension_sortByStrike(A.MarketListExtension_coercedToMoney(A.MarketListExtension_get_calls(A.MarketListExtension_whereUnderlyingIs(allMarkets, underlying)), money, oracle), B.Order_0), B.Order_0), t2 = t1.$ti, t1 = new A.ListIterator(t1, t1.get$length(0), t2._eval$1("ListIterator<ListIterable.E>")), t3 = type$.JSArray_Position, t4 = slippage >= 0, t5 = type$.Option, t6 = type$.Expirable, t2 = t2._eval$1("ListIterable.E"), t7 = slippage <= 1, t8 = "Slippage ratio must be in [0, 1], was: " + A.S(slippage);
              case 2:
                // for condition
                if (!t1.moveNext$0()) {
                  // goto after for
                ...
                t9 = t1.__internal$_current;
                $call = t9 == null ? t2._as(t9) : t9;
                $async$handler = 5;
                option = t5._as($call.get$asset());
                expiration = t6._as($call.get$asset()).expiration;
                moneyProb = null;
                underlyingProb = null;
                try {
                  moneyProb = probs.getProbability$2(expiration, option.strike);
                  underlyingProb = 1 - moneyProb;
                } catch (exception) {
                }
                t9 = $call;
                t10 = t9.get$money();
                t11 = t9.get$askPrice();
                if (!(t4 && t7))
                  A.throwExpression(A.ArgumentError$(t8, null));
                t9 = A._MergedPosition$(A._setArrayType([new A.Line(t10, t11 - (t9.get$askPrice() - t9.get$bidPrice()) * slippage), new A.Line(t9.get$asset(), 1).$negate(0)], t3));
                t10 = spotMarket;
                t11 = t10.get$asset();
                t12 = t10.get$money();
                t13 = t10.get$bidPrice();
                if (!(t4 && t7))
                  A.throwExpression(A.ArgumentError$(t8, null));
                t10 = A._MergedPosition$(A._setArrayType([new A.Line(t11, 1), new A.Line(t12, t13 + (t10.get$askPrice() - t10.get$bidPrice()) * slippage).$negate(0)], t3));
                t11 = option.contractLot;
                t9 = A._MergedPosition$(A._setArrayType([t9, t11 === 1 ? t10 : new A._ScaledPosition(t10, t11)], t3));
                t10 = option.minSize;
                t9 = t10 === 1 ? t9 : new A._ScaledPosition(t9, t10);
                t10 = spotMarket;
                t11 = option;
                t12 = spotMarket;
                t12 = (t12.get$bidPrice() + t12.get$askPrice()) / 2;
                t13 = moneyProb;
                t14 = underlyingProb;
                t15 = A.PositionAnalyzer$(t9, money, underlying);
                t16 = t9.$index(0, money);
                t9.$index(0, underlying);
                t17 = t9.$index(0, t11);
                t18 = t9.$index(0, money);
                t18 = t10.toAsset$1(new A.Line(t18.asset, t18.size * -1));
                t11 = t11.strike;
                t14 = new A.CoveredCall(underlying, money, expiration, t10, t15, t9, t17, t16, t18, t12, new A.PriceInfo(t11, t11 / t12), t13, t14);
                t13 = A._MergedPosition$(A._setArrayType([t9.$index(0, underlying), t18.$negate(0)], t3)).singleton$1(underlying);
                t14.__CoveredCall_premiumToReceive_F = t13;
                t14.__CoveredCall_moneyYield_F = 1 + Math.max(t15.get$maxValue(), 0) / Math.max(-t15.get$minValue(), 0);
                t14.__CoveredCall_underlyingYield_F = t13.size / t18.size + 1;
                t14.__CoveredCall_moneyProfit_F = Math.max(t15.get$maxValue(), 0);
                t16 = J.get$last$ax(A.PositionAnalyzer$(A._MergedPosition$(A._setArrayType([t9, A._MergedPosition$(A._setArrayType([t16, t10.toAsset$1(new A.Line(t16.asset, t16.size * -1))], t3)).$negate(0)], t3)), money, underlying).whereValueIs$1(0));
                t10 = t16.fromPrice;
                if (t10 !== t16.toPrice)
                  A.throwExpression(A.ArgumentError$("isPoint == false", null));
                t14.__CoveredCall_breakEvenVsFullUnderlying_F = new A.PriceInfo(t10, t10 / t12);
                if (J.get$isEmpty$asx(t15.whereValueIs$1(0)))
                  A.throwExpression(A.Exception_Exception("No breakeven!\nStrategy: " + t9.toString$0(0) + "\nAnalyzer: " + t15.toString$0(0)));
                t9 = J.get$first$ax(t15.whereValueIs$1(0)).fromPrice;
                t14.__CoveredCall_breakEvenVsFullMoney_F = new A.PriceInfo(t9, t9 / t12);
                $async$goto = 8;
                return $async$iterator._async$_current = t14, 1;
              case 8:
                // after yield
                $async$handler = 1;
                // goto after finally
              ...
              case 5:
                ...
                t9 = A.S($call);
                t10 = A.S(e);
                A.printString("Skipped Covered Call on " + t9 + " due to error: " + t10);
                // goto after finally
                $async$goto = 7;
                break;
              case 4:
    ...
    LongCall_generateAll(allMarkets, money, slippage, underlying) {
      return new A._SyncStarIterable(A.LongCall_generateAll$body(allMarkets, money, slippage, underlying), type$._SyncStarIterable_LongCall);
    },
    LongCall_generateAll$body($async$allMarkets, $async$money, $async$slippage, $async$underlying) {
      return function() {
        var allMarkets = $async$allMarkets,
          money = $async$money,
          slippage = $async$slippage,
          underlying = $async$underlying;
        var $async$goto = 0, $async$handler = 1, $async$errorStack = [], $call, e, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, exception, oracle, spotMarket, $async$exception;
        return function $async$LongCall_generateAll($async$iterator, $async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$errorStack.push($async$result);
            $async$goto = $async$handler;
          }
          for (;;)
            switch ($async$goto) {
              case 0:
                ...
                oracle = A._RealMarketsOracle$(allMarkets);
                spotMarket = oracle.marketFor$2$asset$money(underlying, money);
                t1 = A.MarketListExtension_sortByExpiration(A.MarketListExtension_sortByStrike(A.MarketListExtension_coercedToMoney(A.MarketListExtension_get_calls(A.MarketListExtension_whereUnderlyingIs(allMarkets, underlying)), money, oracle), B.Order_0), B.Order_0), t2 = t1.$ti, t1 = new A.ListIterator(t1, t1.get$length(0), t2._eval$1("ListIterator<ListIterable.E>")), t3 = type$.JSArray_Position, t4 = type$.Option, t5 = type$.Expirable, t6 = slippage >= 0, t2 = t2._eval$1("ListIterable.E"), t7 = slippage <= 1, t8 = "Slippage ratio must be in [0, 1], was: " + A.S(slippage);
              case 2:
                // for condition
                if (!t1.moveNext$0()) {
                  // goto after for
                ...
                if (!(t6 && t7))
                  A.throwExpression(A.ArgumentError$(t8, null));
                t9 = A._MergedPosition$(A._setArrayType([new A.Line(t10, 1), new A.Line(t11, t12 + (t9.get$askPrice() - t9.get$bidPrice()) * slippage).$negate(0)], t3));
                t10 = t4._as($call.get$asset()).minSize;
                t9 = t10 === 1 ? t9 : new A._ScaledPosition(t9, t10);
                t10 = spotMarket;
                t11 = t4._as($call.get$asset());
                t12 = t5._as($call.get$asset());
                t13 = spotMarket;
                t13 = (t13.get$bidPrice() + t13.get$askPrice()) / 2;
                t14 = A.PositionAnalyzer$(t9, money, underlying);
                t15 = t9.$index(0, t11);
                t16 = t9.$index(0, money);
                t17 = t9.$index(0, money);
                t17 = t10.toAsset$1(new A.Line(t17.asset, t17.size * -1));
                t11 = t11.strike;
                t11 = new A.LongCall(underlying, money, t12.expiration, t10, t14, t9, t15, t16, t13, new A.PriceInfo(t11, t11 / t13), t17);
                if (J.get$isEmpty$asx(t14.whereValueIs$1(0)))
                  A.throwExpression(A.Exception_Exception("No breakeven!\nStrategy: " + t9.toString$0(0) + "\nAnalyzer: " + t14.toString$0(0)));
                t12 = J.get$first$ax(t14.whereValueIs$1(0)).fromPrice;
                t11.__LongCall_breakEvenVsFullMoney_F = new A.PriceInfo(t12, t12 / t13);
                t16 = J.get$last$ax(A.PositionAnalyzer$(A._MergedPosition$(A._setArrayType([t9, A._MergedPosition$(A._setArrayType([t16, t10.toAsset$1(new A.Line(t16.asset, t16.size * -1))], t3)).$negate(0)], t3)), money, underlying).whereValueIs$1(0));
                t9 = t16.fromPrice;
                if (t9 !== t16.toPrice)
                  A.throwExpression(A.ArgumentError$("isPoint == false", null));
                t11.__LongCall_breakEvenVsFullUnderlying_F = new A.PriceInfo(t9, t9 / t13);
                t11.__LongCall_maxLeverage_F = t15.size / t17.size;
                $async$goto = 8;
                return $async$iterator._async$_current = t11, 1;
              case 8:
                // after yield
                $async$handler = 1;
                // goto after finally
              ...
              case 5:
                ...
                t9 = A.S($call);
                t10 = A.S(e);
                A.printString("Skipped Long Call on " + t9 + " due to error: " + t10);
                // goto after finally
                $async$goto = 7;
                break;
              case 4:
    ...
    LongPut_generateAll(allMarkets, money, slippage, underlying) {
      return new A._SyncStarIterable(A.LongPut_generateAll$body(allMarkets, money, slippage, underlying), type$._SyncStarIterable_LongPut);
    },
    LongPut_generateAll$body($async$allMarkets, $async$money, $async$slippage, $async$underlying) {
      return function() {
        var allMarkets = $async$allMarkets,
          money = $async$money,
          slippage = $async$slippage,
          underlying = $async$underlying;
        var $async$goto = 0, $async$handler = 1, $async$errorStack = [], put, e, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, exception, oracle, spotMarket, $async$exception;
        return function $async$LongPut_generateAll($async$iterator, $async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$errorStack.push($async$result);
            $async$goto = $async$handler;
          }
          for (;;)
            switch ($async$goto) {
              case 0:
                ...
                oracle = A._RealMarketsOracle$(allMarkets);
                spotMarket = oracle.marketFor$2$asset$money(underlying, money);
                t1 = A.MarketListExtension_sortByExpiration(A.MarketListExtension_sortByStrike(A.MarketListExtension_coercedToMoney(A.MarketListExtension_get_puts(A.MarketListExtension_whereUnderlyingIs(allMarkets, underlying)), money, oracle), B.Order_1), B.Order_0), t2 = t1.$ti, t1 = new A.ListIterator(t1, t1.get$length(0), t2._eval$1("ListIterator<ListIterable.E>")), t3 = type$.JSArray_Position, t4 = type$.Option, t5 = type$.Expirable, t6 = slippage >= 0, t2 = t2._eval$1("ListIterable.E"), t7 = slippage <= 1, t8 = "Slippage ratio must be in [0, 1], was: " + A.S(slippage);
              case 2:
                // for condition
                if (!t1.moveNext$0()) {
                  // goto after for
                ...
                if (!(t6 && t7))
                  A.throwExpression(A.ArgumentError$(t8, null));
                t9 = A._MergedPosition$(A._setArrayType([new A.Line(t10, 1), new A.Line(t11, t12 + (t9.get$askPrice() - t9.get$bidPrice()) * slippage).$negate(0)], t3));
                t10 = t4._as(put.get$asset()).minSize;
                t9 = t10 === 1 ? t9 : new A._ScaledPosition(t9, t10);
                t10 = spotMarket;
                t11 = t4._as(put.get$asset());
                t12 = t5._as(put.get$asset());
                t13 = spotMarket;
                t13 = (t13.get$bidPrice() + t13.get$askPrice()) / 2;
                t14 = A.PositionAnalyzer$(t9, money, underlying);
                t15 = t9.$index(0, t11);
                ...
                t17 = t10.toAsset$1(new A.Line(t17.asset, t17.size * -1));
                t11 = t11.strike;
                t11 = new A.LongPut(underlying, money, t12.expiration, t10, t14, t9, t15, t16, t13, new A.PriceInfo(t11, t11 / t13), t17);
                if (J.get$isEmpty$asx(t14.whereValueIs$1(0)))
                  A.throwExpression(A.Exception_Exception("No breakeven!\nStrategy: " + t9.toString$0(0) + "\nAnalyzer: " + t14.toString$0(0)));
                t12 = J.get$first$ax(t14.whereValueIs$1(0)).fromPrice;
                t11.__LongPut_breakEvenVsFullMoney_F = new A.PriceInfo(t12, t12 / t13);
                t16 = J.get$last$ax(A.PositionAnalyzer$(A._MergedPosition$(A._setArrayType([t9, A._MergedPosition$(A._setArrayType([t16, t10.toAsset$1(new A.Line(t16.asset, t16.size * -1))], t3)).$negate(0)], t3)), money, underlying).whereValueIs$1(0));
                t9 = t16.fromPrice;
                if (t9 !== t16.toPrice)
                  A.throwExpression(A.ArgumentError$("isPoint == false", null));
                t11.__LongPut_breakEvenVsFullUnderlying_F = new A.PriceInfo(t9, t9 / t13);
                t11.__LongPut_maxLeverage_F = t15.size / t17.size;
                t11.__LongPut_maxMoneyYield_F = 1 + Math.max(t14.get$maxValue(), 0) / Math.max(-t14.get$minValue(), 0);
                t11.__LongPut_maxMoneyProfit_F = Math.max(t14.get$maxValue(), 0);
                $async$goto = 8;
                return $async$iterator._async$_current = t11, 1;
              case 8:
                // after yield
              ...
              case 5:
                ...
                t9 = A.S(put);
                t10 = A.S(e);
                A.printString("Skipped Long Put on " + t9 + " due to error: " + t10);
                // goto after finally
                $async$goto = 7;
                break;
              case 4:
    ...
    Straddle_generateAll(allMarkets, money, slippage, underlying) {
      return new A._SyncStarIterable(A.Straddle_generateAll$body(allMarkets, money, slippage, underlying), type$._SyncStarIterable_Straddle);
    },
    Straddle_generateAll$body($async$allMarkets, $async$money, $async$slippage, $async$underlying) {
      return function() {
        var allMarkets = $async$allMarkets,
          money = $async$money,
          slippage = $async$slippage,
          underlying = $async$underlying;
        var $async$goto = 0, $async$handler = 2, $async$errorStack = [], expiration, bestStraddle, strikeEntry, callMarket, putMarket, minSize, strategy, straddle, e, t2, t3, t4, t5, t6, t7, entry, strikeGroups, t8, t9, markets, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, straddle0, bvsMoney, breakevensVsUnderlying, exception, oracle, spotMarket, t1, spotPrice, expirationGroups;
        return function $async$Straddle_generateAll($async$iterator, $async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$errorStack.push($async$result);
            $async$goto = $async$handler;
          }
            ...
            $async$outer:
              switch ($async$goto) {
                case 0:
                  ...
                  spotMarket = oracle.marketFor$2$asset$money(underlying, money);
                  t1 = spotMarket;
                  spotPrice = (t1.get$bidPrice() + t1.get$askPrice()) / 2;
                  expirationGroups = A.MarketListExtension_groupByExpiration(A.MarketListExtension_coercedToMoney(A.MarketListExtension_optionsWithStrikeInMoney(A.MarketListExtension_whereUnderlyingIs(allMarkets, underlying), money), money, oracle), B.Order_0);
                  t1 = new A.LinkedHashMapEntriesIterable(expirationGroups, A._instanceType(expirationGroups)._eval$1("LinkedHashMapEntriesIterable<1,2>")).get$iterator(0), t2 = type$.Market, t3 = type$.JSArray_Position, t4 = type$.Option, t5 = slippage >= 0, t6 = slippage <= 1, t7 = "Slippage ratio must be in [0, 1], was: " + A.S(slippage);
                case 3:
                  // for condition
                  if (!t1.moveNext$0()) {
                    // goto after for
                  ...
                  strikeGroups = A.MarketListExtension_groupByStrike(entry.value, B.Order_0);
                  bestStraddle = null;
                  for (t8 = new A.LinkedHashMapEntryIterator(strikeGroups, strikeGroups._modifications, strikeGroups._first, A._instanceType(strikeGroups)._eval$1("LinkedHashMapEntryIterator<1,2>")); t8.moveNext$0();) {
                    t9 = t8.__js_helper$_current;
                    t9.toString;
                    strikeEntry = t9;
                    markets = strikeEntry.value;
                    callMarket = A.IterableExtensions_get_singleOrNull(A.MarketListExtension_get_calls(markets), t2);
                    putMarket = A.IterableExtensions_get_singleOrNull(A.MarketListExtension_get_puts(markets), t2);
                    if (callMarket != null && putMarket != null)
                      try {
                        minSize = Math.max(t4._as(callMarket.get$asset()).minSize, t4._as(putMarket.get$asset()).minSize);
                        t9 = callMarket;
                        t10 = t9.get$asset();
                        t11 = t9.get$money();
                        t12 = t9.get$bidPrice();
                        if (!(t5 && t6))
                          A.throwExpression(A.ArgumentError$(t7, null));
                        t9 = A._MergedPosition$(A._setArrayType([new A.Line(t10, 1), new A.Line(t11, t12 + (t9.get$askPrice() - t9.get$bidPrice()) * slippage).$negate(0)], t3));
                        t10 = A._asDouble(minSize);
                        t9 = t10 === 1 ? t9 : new A._ScaledPosition(t9, t10);
                        t10 = putMarket;
                        t11 = t10.get$asset();
                        t12 = t10.get$money();
                        ...
                        if (!(t5 && t6))
                          A.throwExpression(A.ArgumentError$(t7, null));
                        t10 = A._MergedPosition$(A._setArrayType([new A.Line(t11, 1), new A.Line(t12, t13 + (t10.get$askPrice() - t10.get$bidPrice()) * slippage).$negate(0)], t3));
                        t11 = A._asDouble(minSize);
                        strategy = A._MergedPosition$(A._setArrayType([t9, t11 === 1 ? t10 : new A._ScaledPosition(t10, t11)], t3));
                        t9 = strategy;
                        t10 = callMarket;
                        t11 = putMarket;
                        t12 = spotMarket;
                        t13 = spotPrice;
                        t4._as(t10.get$asset());
                        t4._as(t11.get$asset());
                        t14 = A.PositionAnalyzer$(t9, money, underlying);
                        t15 = t4._as(t10.get$asset());
                        t16 = t9._assetPositions;
                        t17 = t16.$index(0, t15);
                        t17.toString;
                        t18 = t4._as(t11.get$asset());
                        t19 = t16.$index(0, t18);
                        t19.toString;
                        t20 = t16.$index(0, money);
                        t20.toString;
                        t21 = new A.Line(money, t20);
                        t16 = t16.$index(0, money);
                        t16.toString;
                        t16 = t12.toAsset$1(new A.Line(money, t16 * -1));
                        t22 = t4._as(t10.get$asset()).strike;
                        straddle0 = new A.Straddle(underlying, money, expiration, t12, t10, t11, slippage, t14, t9, new A.Line(t15, t17), new A.Line(t18, t19), t21, t13, new A.PriceInfo(t22, t22 / t13), t16);
                        bvsMoney = J.toList$0$ax(t14.whereValueIs$1(0));
                        if (bvsMoney.length < 2)
                          A.throwExpression(A.Exception_Exception("Expected at least two breakevens versus money for Straddle!\nStrategy: " + t9.toString$0(0) + "\nAnalyzer: " + t14.toString$0(0)));
                        t10 = B.JSArray_methods.get$first(bvsMoney).fromPrice;
                        straddle0.__Straddle_breakEvenVsFullMoneyDown_F = new A.PriceInfo(t10, t10 / t13);
                        t11 = B.JSArray_methods.get$last(bvsMoney).fromPrice;
                        straddle0.__Straddle_breakEvenVsFullMoneyUp_F = new A.PriceInfo(t11, t11 / t13);
                        t10 = t11 - t10;
                        straddle0.__Straddle_distanceBetweenBreakEvens_F = new A.PriceInfo(t10, t10 / t13);
                        breakevensVsUnderlying = J.toList$0$ax(A.PositionAnalyzer$(A._MergedPosition$(A._setArrayType([t9, A._MergedPosition$(A._setArrayType([t21, t12.toAsset$1(new A.Line(money, t20 * -1))], t3)).$negate(0)], t3)), money, underlying).whereValueIs$1(0));
                        if (breakevensVsUnderlying.length < 2)
                          A.throwExpression(A.Exception_Exception("Expected at least two breakevens versus underlying for Straddle!\nStrategy: " + t9.toString$0(0) + "\nAnalyzer: " + t14.toString$0(0)));
                        t9 = B.JSArray_methods.get$first(breakevensVsUnderlying).fromPrice;
                        straddle0.__Straddle_breakEvenVsFullUnderlyingDown_F = new A.PriceInfo(t9, t9 / t13);
                        t9 = B.JSArray_methods.get$last(breakevensVsUnderlying).fromPrice;
                        straddle0.__Straddle_breakEvenVsFullUnderlyingUp_F = new A.PriceInfo(t9, t9 / t13);
                        straddle = straddle0;
                        if (bestStraddle != null) {
                          t9 = straddle.strikePrice;
                          t10 = spotPrice;
                          ...
                          t12 = Math.abs(t9.absolute - t10) < Math.abs(t11.absolute - t12);
                          t9 = t12;
                        } else
                          t9 = true;
                        if (t9)
                        ...
                        t9 = strikeEntry.key;
                        t10 = A.S(e);
                        A.printString("Skipped Straddle at " + A.S(t9) + " due to error: " + t10);
                      }
                  }
                  $async$goto = bestStraddle != null ? 5 : 6;
                  break;
                case 5:
                  // then
                  $async$goto = 7;
                  return $async$iterator._async$_current = bestStraddle, 1;
                case 7:
                  // after yield
                case 6:
                  // join
    ...
    VerticalSpread_pickNearestBoundary(target, priceRanges) {
      return A.VerticalSpread_pickNearest(target, J.expand$1$1$ax(priceRanges, new A.VerticalSpread_pickNearestBoundary_closure(), type$.double));
    },
    VerticalSpread_pickNearest(target, candidates) {
      var candidate, distance, candidate0, t2, t3, newDistance,
        t1 = candidates.$ti,
        it = new A.ExpandIterator(J.get$iterator$ax(candidates.__internal$_iterable), candidates._f, B.C_EmptyIterator, t1._eval$1("ExpandIterator<1,2>"));
      if (!it.moveNext$0())
        return null;
      candidate = it.__internal$_current;
      if (candidate == null)
        candidate = t1._rest[1]._as(candidate);
      distance = Math.abs(target - candidate);
      for (t1 = t1._rest[1]; it.moveNext$0();) {
        candidate0 = it.__internal$_current;
        t2 = candidate0 == null;
        t3 = t2 ? t1._as(candidate0) : candidate0;
        if (typeof t3 !== "number")
          return A.iae(t3);
        newDistance = Math.abs(target - t3);
        if (newDistance < distance) {
          candidate = t2 ? t1._as(candidate0) : candidate0;
          distance = newDistance;
        }
      }
      return candidate;
    },
    VerticalSpread_generateAll(allMarkets, money, slippage, underlying) {
      return new A._SyncStarIterable(A.VerticalSpread_generateAll$body(allMarkets, money, slippage, underlying), type$._SyncStarIterable_VerticalSpread);
    },
    VerticalSpread_generateAll$body($async$allMarkets, $async$money, $async$slippage, $async$underlying) {
      return function() {
        var allMarkets = $async$allMarkets,
          money = $async$money,
          slippage = $async$slippage,
          underlying = $async$underlying;
        var $async$goto = 0, $async$handler = 1, $async$errorStack = [], t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, expirationToStrike, expiration, strikeToOptions, makeSpread, t11, t12, t13, lowStrike, highStrike, _1_0, lowCall, lowPut, _2_0, highCall, highPut, t14, t15, t16, t17, t18, under, oracle, spotMarket, spotPrice;
        return function $async$VerticalSpread_generateAll($async$iterator, $async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$errorStack.push($async$result);
            $async$goto = $async$handler;
          }
          for (;;)
            switch ($async$goto) {
              case 0:
                ...
                oracle = A._RealMarketsOracle$(allMarkets);
                spotMarket = oracle.marketFor$2$asset$money(underlying, money);
                spotPrice = (spotMarket.get$bidPrice() + spotMarket.get$askPrice()) / 2;
                t1 = A.MarketsMapExtension_mapValues(A.MarketListExtension_groupByExpiration(A.MarketListExtension_coercedToMoney(A.MarketListExtension_optionsWithStrikeInMoney(A.MarketListExtension_whereUnderlyingIs(allMarkets, underlying), money), money, oracle), B.Order_0), new A.VerticalSpread_generateAll_closure(), type$.DateTime, type$.Map_of_double_and_Record_2_nullable_Market_call_and_nullable_Market_put), t1 = new A.LinkedHashMapEntriesIterable(t1, A._instanceType(t1)._eval$1("LinkedHashMapEntriesIterable<1,2>")).get$iterator(0), t2 = type$.double, t3 = type$.JSArray_nullable_VerticalSpread, t4 = type$.NonNullsIterable_VerticalSpread, t5 = type$.JSArray_VerticalSpread, t6 = type$.JSArray_Position, t7 = type$.Option, t8 = slippage >= 0, t9 = slippage <= 1, t10 = "Slippage ratio must be in [0, 1], was: " + A.S(slippage);
              case 2:
                // for condition
                if (!t1.moveNext$0()) {
                  // goto after for
                ...
                expirationToStrike = t1.__js_helper$_current;
                expiration = expirationToStrike.key;
                strikeToOptions = expirationToStrike.value;
                makeSpread = new A.VerticalSpread_generateAll_makeSpread(underlying, money, expiration, spotMarket, spotPrice);
                t11 = A.VerticalSpread__pairUp(strikeToOptions.get$keys(), t2), t12 = t11.$ti, t11 = new A._SyncStarIterator(t11._outerHelper(), t12._eval$1("_SyncStarIterator<1>")), t12 = t12._precomputed1;
              case 4:
                // for condition
                if (!t11.moveNext$0()) {
                  // goto after for
                ...
                t13 = t11._async$_current;
                if (t13 == null)
                  t13 = t12._as(t13);
                lowStrike = t13._0;
                highStrike = t13._1;
                _1_0 = strikeToOptions.$index(0, lowStrike);
                lowCall = _1_0._0;
                lowPut = _1_0._1;
                _2_0 = strikeToOptions.$index(0, highStrike);
                highCall = _2_0._0;
                highPut = _2_0._1;
                t13 = A._setArrayType([], t5);
                t14 = lowPut != null;
                if (t14 && highPut != null) {
                  t15 = highPut.get$asset();
                  t16 = highPut.get$money();
                  t17 = highPut.get$bidPrice();
                  if (!(t8 && t9))
                    A.throwExpression(A.ArgumentError$(t10, null));
                  t15 = A._MergedPosition$(A._setArrayType([new A.Line(t15, 1), new A.Line(t16, t17 + (highPut.get$askPrice() - highPut.get$bidPrice()) * slippage).$negate(0)], t6));
                  t16 = lowPut.get$money();
                  t17 = lowPut.get$askPrice();
                  if (!(t8 && t9))
                    A.throwExpression(A.ArgumentError$(t10, null));
                  t13.push(makeSpread.call$5(A._MergedPosition$(A._setArrayType([t15, A._MergedPosition$(A._setArrayType([new A.Line(t16, t17 - (lowPut.get$askPrice() - lowPut.get$bidPrice()) * slippage), new A.Line(lowPut.get$asset(), 1).$negate(0)], t6))], t6)), t7._as(lowPut.get$asset()), t7._as(highPut.get$asset()), lowPut, highPut));
                }
                t15 = lowCall != null;
                if (t15 && highCall != null) {
                  t16 = highCall.get$asset();
                  t17 = highCall.get$money();
                  t18 = highCall.get$bidPrice();
                  if (!(t8 && t9))
                    A.throwExpression(A.ArgumentError$(t10, null));
                  t16 = A._MergedPosition$(A._setArrayType([new A.Line(t16, 1), new A.Line(t17, t18 + (highCall.get$askPrice() - highCall.get$bidPrice()) * slippage).$negate(0)], t6));
                  t17 = lowCall.get$money();
                  t18 = lowCall.get$askPrice();
                  if (!(t8 && t9))
                    A.throwExpression(A.ArgumentError$(t10, null));
                  t13.push(makeSpread.call$5(A._MergedPosition$(A._setArrayType([t16, A._MergedPosition$(A._setArrayType([new A.Line(t17, t18 - (lowCall.get$askPrice() - lowCall.get$bidPrice()) * slippage), new A.Line(lowCall.get$asset(), 1).$negate(0)], t6))], t6)), t7._as(lowCall.get$asset()), t7._as(highCall.get$asset()), lowCall, highCall));
                }
                under = A.VerticalSpread_keepBestValidSpread(t13);
                t13 = A._setArrayType([], t5);
                if (t14 && highPut != null) {
                  t14 = highPut.get$money();
                  t16 = highPut.get$askPrice();
                  if (!(t8 && t9))
                    A.throwExpression(A.ArgumentError$(t10, null));
                  t14 = A._MergedPosition$(A._setArrayType([new A.Line(t14, t16 - (highPut.get$askPrice() - highPut.get$bidPrice()) * slippage), new A.Line(highPut.get$asset(), 1).$negate(0)], t6));
                  t16 = lowPut.get$asset();
                  t17 = lowPut.get$money();
                  t18 = lowPut.get$bidPrice();
                  if (!(t8 && t9))
                    A.throwExpression(A.ArgumentError$(t10, null));
                  t13.push(makeSpread.call$5(A._MergedPosition$(A._setArrayType([t14, A._MergedPosition$(A._setArrayType([new A.Line(t16, 1), new A.Line(t17, t18 + (lowPut.get$askPrice() - lowPut.get$bidPrice()) * slippage).$negate(0)], t6))], t6)), t7._as(highPut.get$asset()), t7._as(lowPut.get$asset()), highPut, lowPut));
                }
                if (t15 && highCall != null) {
                  t14 = highCall.get$money();
                  t15 = highCall.get$askPrice();
                  if (!(t8 && t9))
                    A.throwExpression(A.ArgumentError$(t10, null));
                  t14 = A._MergedPosition$(A._setArrayType([new A.Line(t14, t15 - (highCall.get$askPrice() - highCall.get$bidPrice()) * slippage), new A.Line(highCall.get$asset(), 1).$negate(0)], t6));
                  t15 = lowCall.get$asset();
                  t16 = lowCall.get$money();
                  t17 = lowCall.get$bidPrice();
                  if (!(t8 && t9))
                    A.throwExpression(A.ArgumentError$(t10, null));
                  t13.push(makeSpread.call$5(A._MergedPosition$(A._setArrayType([t14, A._MergedPosition$(A._setArrayType([new A.Line(t15, 1), new A.Line(t16, t17 + (lowCall.get$askPrice() - lowCall.get$bidPrice()) * slippage).$negate(0)], t6))], t6)), t7._as(highCall.get$asset()), t7._as(lowCall.get$asset()), highCall, lowCall));
                }
                $async$goto = 6;
                return $async$iterator._yieldStar$1(new A.NonNullsIterable(A._setArrayType([under, A.VerticalSpread_keepBestValidSpread(t13)], t3), t4));
              case 6:
                // after yield
                // goto for condition
                $async$goto = 4;
    ...
    VerticalSpread_keepBestValidSpread(spreads) {
      var t1 = A._arrayInstanceType(spreads),
        t2 = t1._eval$1("WhereIterable<1>");
      return new A.WhereIterable(new A.WhereIterable(spreads, t1._eval$1("bool(1)")._as(new A.VerticalSpread_keepBestValidSpread_closure()), t2), t2._eval$1("bool(Iterable.E)")._as(new A.VerticalSpread_keepBestValidSpread_closure0()), t2._eval$1("WhereIterable<Iterable.E>")).fold$1$2(0, null, new A.VerticalSpread_keepBestValidSpread_closure1(), type$.nullable_VerticalSpread);
    },
    VerticalSpread__pairUp(iterable, $T) {
      return new A._SyncStarIterable(A.VerticalSpread__pairUp$body(iterable, $T), $T._eval$1("_SyncStarIterable<+(0,0)>"));
    },
    VerticalSpread__pairUp$body($async$iterable, $async$$T) {
      return function() {
        var iterable = $async$iterable,
          $T = $async$$T;
        var $async$goto = 0, $async$handler = 2, $async$errorStack = [], previous, current, it;
        return function $async$VerticalSpread__pairUp($async$iterator, $async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$errorStack.push($async$result);
            $async$goto = $async$handler;
          }
          for (;;)
            switch ($async$goto) {
              ...
              case 3:
                ...
                $async$goto = 6;
                return $async$iterator._async$_current = new A._Record_2(previous, current), 1;
              case 6:
                // after yield
              case 4:
                // for update
    ...
    _formatDate(dt) {
      return "" + A.Primitives_getYear(dt) + "-" + B.JSString_methods.padLeft$2(B.JSInt_methods.toString$0(A.Primitives_getMonth(dt)), 2, "0") + "-" + B.JSString_methods.padLeft$2(B.JSInt_methods.toString$0(A.Primitives_getDay(dt)), 2, "0");
    },
    _formatDouble(val) {
      var t1 = B.JSNumber_methods.toInt$0(val);
      if (val === t1)
        return B.JSInt_methods.toString$0(t1);
      return B.JSNumber_methods.toString$0(val);
    },
    Probabilities$(spreads, money, underlying) {
      var t1 = new A.Probabilities(A.LinkedHashMap_LinkedHashMap$_empty(type$.DateTime, type$.Map_double_double));
      t1.Probabilities$3$money$underlying(spreads, money, underlying);
      return t1;
    },
    CoveredCall: function CoveredCall(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12) {
      var _ = this;
      _.underlying = t0;
      _.money = t1;
      _.expiration = t2;
      ...
      _.optionLeg = t6;
      _.moneyLeg = t7;
      _.underlyingToBuy = t8;
      _.__CoveredCall_premiumToReceive_F = $;
      _.spotPrice = t9;
      _.strikePrice = t10;
      _.__CoveredCall_breakEvenVsFullMoney_F = _.__CoveredCall_breakEvenVsFullUnderlying_F = _.__CoveredCall_underlyingYield_F = _.__CoveredCall_moneyYield_F = _.__CoveredCall_moneyProfit_F = $;
      _.moneyProbability = t11;
      _.underlyingProbability = t12;
    },
    LongCall: function LongCall(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) {
      var _ = this;
      _.underlying = t0;
      _.money = t1;
      _.expiration = t2;
      ...
      _.spotPrice = t8;
      _.strikePrice = t9;
      _.costInUnderlying = t10;
      _.__LongCall_breakEvenVsFullMoney_F = _.__LongCall_breakEvenVsFullUnderlying_F = _.__LongCall_maxLeverage_F = $;
    },
    LongPut: function LongPut(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) {
      var _ = this;
      _.underlying = t0;
      _.money = t1;
      _.expiration = t2;
      ...
      _.strikePrice = t9;
      _.costInUnderlying = t10;
      _.__LongPut_breakEvenVsFullMoney_F = _.__LongPut_breakEvenVsFullUnderlying_F = _.__LongPut_maxMoneyProfit_F = _.__LongPut_maxMoneyYield_F = _.__LongPut_maxLeverage_F = $;
    },
    Straddle: function Straddle(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14) {
      var _ = this;
      _.underlying = t0;
      _.money = t1;
      _.expiration = t2;
      ...
      _.spotPrice = t12;
      _.strikePrice = t13;
      _.costInUnderlying = t14;
      _.__Straddle_breakEvenVsFullMoneyUp_F = _.__Straddle_breakEvenVsFullMoneyDown_F = _.__Straddle_breakEvenVsFullUnderlyingUp_F = _.__Straddle_breakEvenVsFullUnderlyingDown_F = _.__Straddle_distanceBetweenBreakEvens_F = $;
    },
    VerticalSpreadType: function VerticalSpreadType(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    VerticalSpread: function VerticalSpread(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13) {
      var _ = this;
      _.underlying = t0;
      _.money = t1;
      _.expiration = t2;
      ...
      _.longLeg = t10;
      _.moneyLeg = t11;
      _.__VerticalSpread_type_F = $;
      _.spotMarket = t12;
      _.spotPrice = t13;
      _.__VerticalSpread_probability_F = _.__VerticalSpread_maxRiskAt_F = _.__VerticalSpread_maxRisk_F = _.__VerticalSpread_maxYieldAt_F = _.__VerticalSpread_maxYield_F = _.__VerticalSpread_breakEvenVsFullUnderlying_F = _.__VerticalSpread_breakEvenVsFullMoney_F = $;
    },
    VerticalSpread_pickNearestBoundary_closure: function VerticalSpread_pickNearestBoundary_closure() {
    },
    VerticalSpread_generateAll_closure: function VerticalSpread_generateAll_closure() {
    },
    VerticalSpread_generateAll__closure: function VerticalSpread_generateAll__closure() {
    },
    VerticalSpread_generateAll_makeSpread: function VerticalSpread_generateAll_makeSpread(t0, t1, t2, t3, t4) {
      var _ = this;
      _.underlying = t0;
      _.money = t1;
      _.expiration = t2;
    ...
    VerticalSpread_keepBestValidSpread_closure: function VerticalSpread_keepBestValidSpread_closure() {
    },
    VerticalSpread_keepBestValidSpread_closure0: function VerticalSpread_keepBestValidSpread_closure0() {
    },
    VerticalSpread_keepBestValidSpread_closure1: function VerticalSpread_keepBestValidSpread_closure1() {
    },
    PriceInfo: function PriceInfo(t0, t1) {
      this.absolute = t0;
      this.relative = t1;
    },
    Probabilities: function Probabilities(t0) {
      this._probs = t0;
    },
    Probabilities_closure: function Probabilities_closure() {
    },
    Probabilities_closure0: function Probabilities_closure0() {
    },
    Probabilities_closure1: function Probabilities_closure1() {
    },
    deribitMarkets(ticker, minDTE, maxDTE) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_Market),
        $async$returnValue, t1;
      var $async$deribitMarkets = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $label0$0: {
                if ("BTC" === ticker || "ETH" === ticker) {
                  t1 = ticker;
                  break $label0$0;
                }
                if ("SOL" === ticker || "AVAX" === ticker || "XRP" === ticker || "TRX" === ticker) {
                  t1 = "USDC";
                  break $label0$0;
                }
                t1 = A.throwExpression("Unknown ticker: " + ticker);
              }
              $async$goto = 3;
              return A._asyncAwait(A.Deribit_fetchMarkets(A._setArrayType([t1], type$.JSArray_String), $.$get$_urlFetcher(), new A.deribitMarkets_closure(), maxDTE, minDTE), $async$deribitMarkets);
            case 3:
              // returning from await.
      ...
      return A._asyncStartSync($async$deribitMarkets, $async$completer);
    },
    deribitCoveredCalls(ticker, slippage, minDTE, maxDTE) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, t1, $async$temp1;
      var $async$deribitCoveredCalls = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A.deribitMarkets(ticker, minDTE, maxDTE), $async$deribitCoveredCalls);
            case 3:
              // returning from await.
              t1 = $async$temp1.CoveredCall_generateAll($async$result, new A.Commodity("USD", null), slippage, new A.Commodity(ticker, B.Set_G4DT2));
              t1 = A.List_List$_of(t1, t1.$ti._eval$1("Iterable.E"));
              $async$returnValue = B.C_JsonCodec.encode$2$toEncodable(t1, null);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$deribitCoveredCalls, $async$completer);
    },
    deribitLongOptions(ticker, slippage, minDTE, maxDTE) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, puts, markets, underlying, money, t1, t2, t3, calls;
      var $async$deribitLongOptions = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.deribitMarkets(ticker, minDTE, maxDTE), $async$deribitLongOptions);
            case 3:
              // returning from await.
              markets = $async$result;
              underlying = new A.Commodity(ticker, B.Set_G4DT2);
              money = new A.Commodity("USD", null);
              t1 = A.LongCall_generateAll(markets, money, slippage, underlying);
              t2 = type$.Map_String_dynamic;
              t3 = t1.$ti;
              calls = A.MappedIterable_MappedIterable(t1, t3._eval$1("Map<String,@>(Iterable.E)")._as(new A.deribitLongOptions_closure()), t3._eval$1("Iterable.E"), t2);
              t3 = A.LongPut_generateAll(markets, money, slippage, underlying);
              t1 = t3.$ti;
              puts = A.MappedIterable_MappedIterable(t3, t1._eval$1("Map<String,@>(Iterable.E)")._as(new A.deribitLongOptions_closure0()), t1._eval$1("Iterable.E"), t2);
              t1 = A.List_List$_of(calls, t2);
              B.JSArray_methods.addAll$1(t1, puts);
              $async$returnValue = B.C_JsonCodec.encode$2$toEncodable(t1, null);
              // goto return
              $async$goto = 1;
              break;
      ...
      return A._asyncStartSync($async$deribitLongOptions, $async$completer);
    },
    deribitVerticalSpreads(ticker, slippage, minDTE, maxDTE) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, t1, $async$temp1;
      var $async$deribitVerticalSpreads = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A.deribitMarkets(ticker, minDTE, maxDTE), $async$deribitVerticalSpreads);
            case 3:
              // returning from await.
              t1 = $async$temp1.VerticalSpread_generateAll($async$result, new A.Commodity("USD", null), slippage, new A.Commodity(ticker, B.Set_G4DT2));
              t1 = A.List_List$_of(t1, t1.$ti._eval$1("Iterable.E"));
              $async$returnValue = B.C_JsonCodec.encode$2$toEncodable(t1, null);
              // goto return
              $async$goto = 1;
      ...
      return A._asyncStartSync($async$deribitVerticalSpreads, $async$completer);
    },
    deribitStraddles(ticker, slippage, minDTE, maxDTE) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, t1, $async$temp1;
      var $async$deribitStraddles = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A.deribitMarkets(ticker, minDTE, maxDTE), $async$deribitStraddles);
            case 3:
              // returning from await.
              t1 = $async$temp1.Straddle_generateAll($async$result, new A.Commodity("USD", null), slippage, new A.Commodity(ticker, B.Set_G4DT2));
              t1 = A.List_List$_of(t1, t1.$ti._eval$1("Iterable.E"));
              $async$returnValue = B.C_JsonCodec.encode$2$toEncodable(t1, null);
              // goto return
              $async$goto = 1;
      ...
      return A._asyncStartSync($async$deribitStraddles, $async$completer);
    },
    yfinanceCoveredCalls(ticker, slippage, minDTE, maxDTE) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, t1, $async$temp1;
      var $async$yfinanceCoveredCalls = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = A;
              $async$goto = 4;
              return A._asyncAwait(A.YFinance_openConnection($.$get$_urlFetcher()), $async$yfinanceCoveredCalls);
            case 4:
              // returning from await.
              $async$goto = 3;
              return A._asyncAwait($async$result.fetchMarkets$4$maxDTE$minDTE(ticker, $.$get$_urlFetcher(), maxDTE, minDTE), $async$yfinanceCoveredCalls);
            case 3:
              // returning from await.
              t1 = $async$temp1.CoveredCall_generateAll($async$result, new A.Commodity("USD", null), slippage, new A.Commodity(ticker, B.Set_4AiM));
              t1 = A.List_List$_of(t1, t1.$ti._eval$1("Iterable.E"));
              $async$returnValue = B.C_JsonCodec.encode$2$toEncodable(t1, null);
              // goto return
              $async$goto = 1;
      ...
      return A._asyncStartSync($async$yfinanceCoveredCalls, $async$completer);
    },
    yfinanceLongOptions(ticker, slippage, minDTE, maxDTE) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, puts, markets, underlying, money, t1, t2, t3, calls;
      var $async$yfinanceLongOptions = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 4;
              return A._asyncAwait(A.YFinance_openConnection($.$get$_urlFetcher()), $async$yfinanceLongOptions);
            case 4:
              // returning from await.
              $async$goto = 3;
              return A._asyncAwait($async$result.fetchMarkets$4$maxDTE$minDTE(ticker, $.$get$_urlFetcher(), maxDTE, minDTE), $async$yfinanceLongOptions);
            case 3:
              // returning from await.
              markets = $async$result;
              underlying = new A.Commodity(ticker, B.Set_4AiM);
              money = new A.Commodity("USD", null);
              t1 = A.LongCall_generateAll(markets, money, slippage, underlying);
              t2 = type$.Map_String_dynamic;
              t3 = t1.$ti;
              calls = A.MappedIterable_MappedIterable(t1, t3._eval$1("Map<String,@>(Iterable.E)")._as(new A.yfinanceLongOptions_closure()), t3._eval$1("Iterable.E"), t2);
              t3 = A.LongPut_generateAll(markets, money, slippage, underlying);
              t1 = t3.$ti;
              puts = A.MappedIterable_MappedIterable(t3, t1._eval$1("Map<String,@>(Iterable.E)")._as(new A.yfinanceLongOptions_closure0()), t1._eval$1("Iterable.E"), t2);
              t1 = A.List_List$_of(calls, t2);
              B.JSArray_methods.addAll$1(t1, puts);
              $async$returnValue = B.C_JsonCodec.encode$2$toEncodable(t1, null);
              // goto return
      ...
      return A._asyncStartSync($async$yfinanceLongOptions, $async$completer);
    },
    yfinanceStraddles(ticker, slippage, minDTE, maxDTE) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, t1, $async$temp1;
      var $async$yfinanceStraddles = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = A;
              $async$goto = 4;
              return A._asyncAwait(A.YFinance_openConnection($.$get$_urlFetcher()), $async$yfinanceStraddles);
            case 4:
              // returning from await.
              $async$goto = 3;
              return A._asyncAwait($async$result.fetchMarkets$4$maxDTE$minDTE(ticker, $.$get$_urlFetcher(), maxDTE, minDTE), $async$yfinanceStraddles);
            case 3:
              // returning from await.
              t1 = $async$temp1.Straddle_generateAll($async$result, new A.Commodity("USD", null), slippage, new A.Commodity(ticker, B.Set_4AiM));
              t1 = A.List_List$_of(t1, t1.$ti._eval$1("Iterable.E"));
              $async$returnValue = B.C_JsonCodec.encode$2$toEncodable(t1, null);
              // goto return
              $async$goto = 1;
      ...
      return A._asyncStartSync($async$yfinanceStraddles, $async$completer);
    },
    setupJsInterop() {
      var t1 = init.G;
      t1.deribitCoveredCallsDart = A._functionToJS4(new A.setupJsInterop_closure());
      t1.deribitVerticalSpreadsDart = A._functionToJS4(new A.setupJsInterop_closure0());
      t1.yfinanceCoveredCallsDart = A._functionToJS4(new A.setupJsInterop_closure1());
      t1.deribitLongOptionsDart = A._functionToJS4(new A.setupJsInterop_closure2());
      t1.yfinanceLongOptionsDart = A._functionToJS4(new A.setupJsInterop_closure3());
      t1.deribitStraddlesDart = A._functionToJS4(new A.setupJsInterop_closure4());
      t1.yfinanceStraddlesDart = A._functionToJS4(new A.setupJsInterop_closure5());
    },
    deribitMarkets_closure: function deribitMarkets_closure() {
    },
    deribitLongOptions_closure: function deribitLongOptions_closure() {
    },
    deribitLongOptions_closure0: function deribitLongOptions_closure0() {
    },
    yfinanceLongOptions_closure: function yfinanceLongOptions_closure() {
    },
    yfinanceLongOptions_closure0: function yfinanceLongOptions_closure0() {
    },
    setupJsInterop_closure: function setupJsInterop_closure() {
    },
    setupJsInterop__closure5: function setupJsInterop__closure5() {
    },
    setupJsInterop_closure0: function setupJsInterop_closure0() {
    },
    setupJsInterop__closure4: function setupJsInterop__closure4() {
    },
    setupJsInterop_closure1: function setupJsInterop_closure1() {
    },
    setupJsInterop__closure3: function setupJsInterop__closure3() {
    },
    setupJsInterop_closure2: function setupJsInterop_closure2() {
    },
    setupJsInterop__closure2: function setupJsInterop__closure2() {
    },
    setupJsInterop_closure3: function setupJsInterop_closure3() {
    },
    setupJsInterop__closure1: function setupJsInterop__closure1() {
    },
    setupJsInterop_closure4: function setupJsInterop_closure4() {
    },
    setupJsInterop__closure0: function setupJsInterop__closure0() {
    },
    setupJsInterop_closure5: function setupJsInterop_closure5() {
    },
    setupJsInterop__closure: function setupJsInterop__closure() {
    },
    _parseUri(uri) {
      return uri;
    },
    ...
    Style__getPlatformStyle() {
      ...
      if (!B.JSString_methods.endsWith$1(A.Uri_base().get$path(), "/"))
        return $.$get$Style_url();
      if (A._Uri__Uri("a/b", null).toFilePath$0() === "a\\b")
    ...
    IterableExtension_groupListsBy(_this, keyOf, $T, $K) {
      var t1, t2, element, t3, t4,
        result = A.LinkedHashMap_LinkedHashMap$_empty($K, $T._eval$1("List<0>"));
      for (t1 = _this.get$iterator(_this), t2 = $T._eval$1("JSArray<0>"); t1.moveNext$0();) {
        element = t1.get$current();
        t3 = keyOf.call$1(element);
        t4 = result.$index(0, t3);
        if (t4 == null) {
          t4 = A._setArrayType([], t2);
          result.$indexSet(0, t3, t4);
          t3 = t4;
        } else
          t3 = t4;
    ...
    IterableDoubleExtension_get_minOrNull(_this) {
      var value, newValue,
        t1 = _this.$ti,
        iterator = new A.ListIterator(_this, _this.get$length(0), t1._eval$1("ListIterator<ListIterable.E>"));
      if (iterator.moveNext$0()) {
    ...
    DateTimeAsExpirationExtension_get_formattedDate(_this) {
      var t1 = A.Primitives_getMonth(_this) - 1;
      if (!(t1 >= 0 && t1 < 12))
        return A.ioore(B.List_5MC, t1);
      return "" + A.Primitives_getDay(_this) + " " + B.List_5MC[t1] + " " + A.Primitives_getYear(_this);
    },
    current() {
  ...
  A.IndexedIterable.prototype = {
    ...
    get$first(_) {
      var t1 = this._source;
      return new A._Record_2(this._start, t1.get$first(t1));
    },
    get$single(_) {
      var t1 = this._source;
      return new A._Record_2(this._start, t1.get$single(t1));
    },
    elementAt$1(_, index) {
      return new A._Record_2(index + this._start, this._source.elementAt$1(0, index));
    },
    contains$1(_, element) {
      var _0_2, _0_3, iterator, index = null, other = null,
        t1 = false;
      ...
      if (t1) {
        if (typeof index !== "number")
          return index.$sub();
        t1 = this._source.skip$1(0, index - this._start);
        iterator = t1.get$iterator(t1);
        return iterator.moveNext$0() && J.$eq$(iterator.get$current(), other);
      }
      return false;
    },
    skip$1(_, count) {
      A.ArgumentError_checkNotNull(count, "count", type$.int);
      A.RangeError_checkNotNegative(count, "count");
      return new A.IndexedIterable(this._source.skip$1(0, count), count + this._start, A._instanceType(this)._eval$1("IndexedIterable<1>"));
    },
    get$iterator(_) {
      var t1 = this._source;
      return new A.IndexedIterator(t1.get$iterator(t1), this._start, A._instanceType(this)._eval$1("IndexedIterator<1>"));
    }
  };
  A.EfficientLengthIndexedIterable.prototype = {
    ...
    contains$1(_, element) {
      ...
      if (t1) {
        ...
        t1 = this._source;
        return unbiasedIndex < t1.get$length(t1) && J.$eq$(t1.elementAt$1(0, unbiasedIndex), other);
      }
      return false;
    },
    skip$1(_, count) {
      A.ArgumentError_checkNotNull(count, "count", type$.int);
      A.RangeError_checkNotNegative(count, "count");
      return new A.EfficientLengthIndexedIterable(this._source.skip$1(0, count), this._start + count, this.$ti);
    },
    $isEfficientLengthIterable: 1
  };
  ...
  A._Record_2_call_put.prototype = {
    get$$call() {
      return this._0;
    },
    call$1(arg0) {
      return this.get$$call().call$1(arg0);
    },
    call$2(arg0, arg1) {
      return this.get$$call().call$2(arg0, arg1);
    },
    call$0() {
      return this.get$$call().call$0();
    },
    call$1$1(arg0, $T1) {
      return this.get$$call().call$1$1(arg0, $T1);
    },
    call$3(arg0, arg1, arg2) {
      return this.get$$call().call$3(arg0, arg1, arg2);
    },
    call$4(arg0, arg1, arg2, arg3) {
      return this.get$$call().call$4(arg0, arg1, arg2, arg3);
    },
    call$4$maxDTE$minDTE(arg0, arg1, arg2, arg3) {
      return this.get$$call().call$4$maxDTE$minDTE(arg0, arg1, arg2, arg3);
    },
    call$2$asset$money(arg0, arg1) {
      return this.get$$call().call$2$asset$money(arg0, arg1);
    },
    call$1$0($T1) {
      return this.get$$call().call$1$0($T1);
    },
    call$1$end(arg0) {
      return this.get$$call().call$1$end(arg0);
    },
    call$1$text(arg0) {
      return this.get$$call().call$1$text(arg0);
    },
    call$1$line(arg0) {
      return this.get$$call().call$1$line(arg0);
    },
    call$1$growable(arg0) {
      return this.get$$call().call$1$growable(arg0);
    },
    call$2$withDrive(arg0, arg1) {
      return this.get$$call().call$2$withDrive(arg0, arg1);
    },
    call$1$scheme(arg0) {
      return this.get$$call().call$1$scheme(arg0);
    },
    call$4$cancelOnError$onDone$onError(arg0, arg1, arg2, arg3) {
      return this.get$$call().call$4$cancelOnError$onDone$onError(arg0, arg1, arg2, arg3);
    },
    call$3$cancelOnError$onDone(arg0, arg1, arg2) {
      return this.get$$call().call$3$cancelOnError$onDone(arg0, arg1, arg2);
    },
    call$1$query(arg0) {
      return this.get$$call().call$1$query(arg0);
    },
    call$5(arg0, arg1, arg2, arg3, arg4) {
      return this.get$$call().call$5(arg0, arg1, arg2, arg3, arg4);
    },
    $recipe: "+call,put(1,2)",
    $shape: 2
  };
  ...
  A.Stream.prototype = {
    ...
    toSet$0(_) {
      var t1 = A._instanceType(this),
        result = A.LinkedHashSet_LinkedHashSet(t1._eval$1("Stream.T")),
        future = new A._Future($.Zone__current, t1._eval$1("_Future<Set<Stream.T>>"));
      this.listen$4$cancelOnError$onDone$onError(new A.Stream_toSet_closure(this, result), true, new A.Stream_toSet_closure0(future, result), future.get$_completeError());
      return future;
    }
  };
  ...
  A.Stream_toSet_closure.prototype = {
    call$1(data) {
      this.result.add$1(0, A._instanceType(this.$this)._eval$1("Stream.T")._as(data));
    },
    $signature() {
      return A._instanceType(this.$this)._eval$1("~(Stream.T)");
    }
  };
  A.Stream_toSet_closure0.prototype = {
    call$0() {
  ...
  A._StreamController.prototype = {
    ...
    _subscribe$4(onData, onError, onDone, cancelOnError) {
      ...
      subscription = new A._ControllerSubscription(_this, t5, t6, t7._as(onDone), t2, t3 | t4, t1._eval$1("_ControllerSubscription<1>"));
  ...
  A.SplayTreeSet.prototype = {
    ...
    get$single(_) {
      ...
      throw A.wrapException(t1 === 0 ? A.IterableElementError_noElement() : A.IterableElementError_tooMany());
    },
    contains$1(_, element) {
      return this._untypedLookup$1(element) != null;
    },
    add$1(_, element) {
      return this._add$1(this.$ti._precomputed1._as(element));
    },
    _add$1(element) {
  ...
  A.DateTime.prototype = {
    difference$1(other) {
      return A.Duration$(this._microsecond - other._microsecond, this._value - other._value, 0);
    },
    $eq(_, other) {
      if (other == null)
        return false;
  ...
  A.Iterable.prototype = {
    ...
    fold$1$2(_, initialValue, combine, $T) {
      var t1, value;
      $T._as(initialValue);
      A.instanceType(this)._bind$1($T)._eval$1("1(1,Iterable.E)")._as(combine);
    ...
    firstWhere$1(_, test) {
      var t1, element;
      A.instanceType(this)._eval$1("bool(Iterable.E)")._as(test);
      for (t1 = this.get$iterator(this); t1.moveNext$0();) {
        element = t1.get$current();
        if (test.call$1(element))
          return element;
  ...
  A._Uri.prototype = {
    ...
    replace$2$query$scheme(query, scheme) {
      var schemeChanged, isFile, userInfo, port, host, currentPath, t1, path, _this = this,
    ...
    replace$1$scheme(scheme) {
      return this.replace$2$query$scheme(null, scheme);
    },
    replace$1$query(query) {
      return this.replace$2$query$scheme(query, null);
    },
  ...
  A._SimpleUri.prototype = {
    ...
    replace$2$query$scheme(query, scheme) {
      var schemeChanged, isFile, t1, userInfo, port, host, t2, path, t3, fragment, _this = this, _null = null;
      if (scheme != null) {
        scheme = A._Uri__makeScheme(scheme, 0, scheme.length);
      ...
      if (query != null) {
        ...
        if (t2 < t3)
          query = B.JSString_methods.substring$2(t1, t2 + 1, t3);
      }
  ...
  A.MemoryCache.prototype = {
    read$1$1(key, $T) {
      if (this._expiryAwareContains$1(key))
        return $T._eval$1("0?")._as(this._cache$_cache.$index(0, key).value);
      return null;
    },
    _isExpired$1(item) {
      var t2, t3,
    ...
    _expiryAwareContains$1(key) {
      var t1 = this._cache$_cache,
        item = t1.$index(0, key);
      if (item == null)
        return false;
      else if (this._isExpired$1(item)) {
        t1.remove$1(0, key);
        return false;
      }
      return true;
  ...
  A.CacheItem.prototype = {};
  A.Venue.prototype = {
    _enumToString$0() {
      return "Venue." + this._name;
    }
  };
  A.Asset.prototype = {
    get$venues() {
      var t1 = this._venues;
      return t1 == null ? B.Set_empty : t1;
    },
    toString$0(_) {
      return this.name;
    },
    $eq(_, other) {
      if (other == null)
        return false;
      return other instanceof A.Asset && this.name === other.name;
    },
    get$hashCode(_) {
  ...
  A.Position.prototype = {
    ...
    $mul(_, size) {
      return size === 1 ? this : new A._ScaledPosition(this, size);
    },
    $index(_, asset) {
      type$.Asset._as(asset);
      return J.firstWhere$1$ax(this.decompose$0(), new A.Position_operator$index_closure(asset));
    },
    singleton$1(expectedAsset) {
      var single, t1, t2,
        lines = this.decompose$0();
      if (A.IterableExtensions_get_singleOrNull(lines, type$.Line) == null)
        throw A.wrapException(A.StateError$("Unexpected lines, expected " + expectedAsset.toString$0(0) + ", was " + A.S(lines)));
      single = J.get$single$ax(lines);
      t1 = single.asset;
      t2 = expectedAsset.name !== t1.name;
      if (t2)
        throw A.wrapException(A.StateError$("Expected single asset: " + expectedAsset.toString$0(0) + ", got " + t1.toString$0(0)));
      return single;
    }
  };
  A.Position_operator$index_closure.prototype = {
    call$1(line) {
      type$.Line._as(line);
      return line.asset.name === this.asset.name;
    },
    $signature: 37
  };
  A.Line.prototype = {
    $mul(_, size) {
      return new A.Line(this.asset, this.size * size);
    },
    $negate(_) {
      return new A.Line(this.asset, this.size * -1);
    },
    decompose$0() {
      return A._setArrayType([this], type$.JSArray_Line);
    },
    toString$0(_) {
      return A.S(this.size) + " X " + this.asset.toString$0(0);
    }
  };
  A._ScaledPosition.prototype = {
    decompose$0() {
      return J.map$1$1$ax(this.position.decompose$0(), new A._ScaledPosition_decompose_closure(this), type$.Line);
    },
    toString$0(_) {
      return "(" + A.S(this.scale) + " X " + this.position.toString$0(0) + ")";
    }
  };
  A._ScaledPosition_decompose_closure.prototype = {
    call$1(line) {
      type$.Line._as(line);
      return new A.Line(line.asset, line.size * this.$this.scale);
    },
    $signature: 6
  };
  A._MergedPosition.prototype = {
    _MergedPosition$1(positions) {
      var t1, t2, t3, t4;
      for (t1 = J.expand$1$1$ax(positions, new A._MergedPosition_closure(), type$.Line), t2 = t1.$ti, t1 = new A.ExpandIterator(J.get$iterator$ax(t1.__internal$_iterable), t1._f, B.C_EmptyIterator, t2._eval$1("ExpandIterator<1,2>")), t3 = this._assetPositions, t2 = t2._rest[1]; t1.moveNext$0();) {
        t4 = t1.__internal$_current;
        if (t4 == null)
          t4 = t2._as(t4);
        t3.update$3$ifAbsent(t4.asset, new A._MergedPosition_closure0(t4), new A._MergedPosition_closure1(t4));
      }
    },
    decompose$0() {
      return new A._SyncStarIterable(this.decompose$body$_MergedPosition(), type$._SyncStarIterable_Line);
    },
    decompose$body$_MergedPosition() {
      var $async$self = this;
      return function() {
        var $async$goto = 0, $async$handler = 1, $async$errorStack = [], t1, t2;
        return function $async$decompose$0($async$iterator, $async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$errorStack.push($async$result);
            $async$goto = $async$handler;
          }
          for (;;)
            switch ($async$goto) {
              case 0:
                // Function start
                t1 = $async$self._assetPositions.get$entries(), t1 = t1.get$iterator(t1);
              case 2:
                // for condition
                if (!t1.moveNext$0()) {
                  // goto after for
                ...
                t2 = t1.get$current();
                $async$goto = 4;
                return $async$iterator._async$_current = new A.Line(t2.key, t2.value), 1;
              case 4:
                // after yield
                // goto for condition
                $async$goto = 2;
    ...
    $index(_, asset) {
      var t1;
      type$.Asset._as(asset);
      t1 = this._assetPositions.$index(0, asset);
      t1.toString;
      return new A.Line(asset, t1);
    },
    toString$0(_) {
      return "(" + this._assetPositions.toString$0(0) + ")";
    }
  };
  A._MergedPosition_closure.prototype = {
    call$1(pos) {
      return type$.Position._as(pos).decompose$0();
    },
    $signature: 39
  };
  A._MergedPosition_closure0.prototype = {
    call$1(previousSize) {
      return A._asDouble(previousSize) + this.line.size;
    },
    $signature: 22
  };
  A._MergedPosition_closure1.prototype = {
    call$0() {
      return this.line.size;
    },
    $signature: 41
  };
  A.Commodity.prototype = {
    compareTo$1(_, that) {
      return B.JSString_methods.compareTo$1(this.name, type$.Commodity._as(that).name);
    },
    $isComparable: 1
  };
  A.Expirable.prototype = {};
  A.DatedFuture.prototype = {};
  A.Option.prototype = {
    toString$0(_) {
      return this.name + "[strike=" + this.money.toString$0(0) + "]";
    }
  };
  A.Deribit_fetchMarkets_closure.prototype = {
    call$1(rawJson) {
      var t1 = J.map$1$1$ax(type$.List_dynamic._as(type$.Map_String_dynamic._as(B.C_JsonCodec.decode$1(A._asString(rawJson))).$index(0, "result")), new A.Deribit_fetchMarkets__closure(), type$.nullable_ListedInstrument);
      t1 = t1.super$Iterable$where(0, t1.$ti._eval$1("bool(ListIterable.E)")._as(new A.Deribit_fetchMarkets__closure0()));
      return A.CastIterable_CastIterable(t1, t1.$ti._eval$1("Iterable.E"), type$.ListedInstrument);
    },
    $signature: 42
  };
  A.Deribit_fetchMarkets__closure.prototype = {
    call$1(rawInstrument) {
      type$.Map_String_dynamic._as(rawInstrument);
      return new A.ListedInstrument(A._asString(rawInstrument.$index(0, "instrument_name")), A._asString(rawInstrument.$index(0, "base_currency")), A._asString(rawInstrument.$index(0, "quote_currency")), A._asDouble(rawInstrument.$index(0, "mark_price")), A._asDoubleQ(rawInstrument.$index(0, "estimated_delivery_price")), A._asDoubleQ(rawInstrument.$index(0, "last")), A._asDoubleQ(rawInstrument.$index(0, "low")), A._asDoubleQ(rawInstrument.$index(0, "bid_price")), A._asDoubleQ(rawInstrument.$index(0, "mid_price")), A._asDoubleQ(rawInstrument.$index(0, "ask_price")), A._asDoubleQ(rawInstrument.$index(0, "high")), A._asStringQ(rawInstrument.$index(0, "underlying_index")), A._asDoubleQ(rawInstrument.$index(0, "underlying_price")), A._asDoubleQ(rawInstrument.$index(0, "price_change")));
    },
    $signature: 43
  };
  A.Deribit_fetchMarkets__closure0.prototype = {
    call$1(instrument) {
      return type$.nullable_ListedInstrument._as(instrument) != null;
    },
    $signature: 44
  };
  A.Deribit_fetchMarkets_closure0.prototype = {
    call$1(instrument) {
      return A.ListedInstrumentDeribitUtils_toMarket(type$.ListedInstrument._as(instrument), this.errorListener, this.maxDTE, this.minDTE);
    },
    $signature: 45
  };
  A.ListedInstrumentDeribitUtils_toMarket_makeMarket.prototype = {
    call$1(asset) {
      var contractLot = asset instanceof A.Expirable ? asset.contractLot : 1,
        t1 = this._this,
        t2 = t1.bid_price;
      t2.toString;
      t1 = t1.ask_price;
      t1.toString;
      return A.Market_Market$create(t1 * contractLot, asset, t2 * contractLot, this.money);
    },
    $signature: 46
  };
  A.ListedInstrument.prototype = {
    toString$0(_) {
      var _this = this;
      return "instrument_name: " + _this.instrument_name + ",base_currency: " + _this.base_currency + ",quote_currency: " + _this.quote_currency + ",mark_price: " + A.S(_this.mark_price) + ",estimated_delivery_price: " + A.S(_this.estimated_delivery_price) + ",last: " + A.S(_this.last) + ",low: " + A.S(_this.low) + ",bid_price: " + A.S(_this.bid_price) + ",mid_price: " + A.S(_this.mid_price) + ",ask_price: " + A.S(_this.ask_price) + ",high: " + A.S(_this.high) + ",underlying_index: " + A.S(_this.underlying_index) + ",underlying_price: " + A.S(_this.underlying_price) + ",price_change: " + A.S(_this.price_change) + ",";
    }
  };
  A.UrlFetcher.prototype = {
    fetch$2$headers(uri, headers) {
      return this.fetch$body$UrlFetcher(uri, type$.nullable_Map_String_String._as(headers));
    },
    fetch$1(uri) {
      return this.fetch$2$headers(uri, null);
    },
    fetch$body$UrlFetcher(uri, headers) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, isYahoo, finalUri, requestHeaders, response, isYahooCookieWall, cookieHeader, value, e, cached, t2, t3, cookieHeader0, t4, durationLo, durationHi, microsecond, exception, cacheKey, t1, isHandshake, $async$exception;
      var $async$fetch$2$headers = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              cacheKey = $async$self._getCacheKeyIgnoringCrumb$1(uri);
              t1 = B.JSString_methods.contains$1(uri, "fc.yahoo.com");
              isHandshake = t1 || B.JSString_methods.contains$1(uri, "getcrumb");
              if (!isHandshake) {
                cached = $async$self._url_fetcher$_cache.read$1$1(cacheKey, type$.String);
                if (cached != null) {
                  A.print("Return cached...");
                  $async$returnValue = cached;
                  // goto return
                  $async$goto = 1;
                  break;
                }
              ...
              $async$handler = 4;
              isYahoo = B.JSString_methods.contains$1(uri, "yahoo.com");
              finalUri = isYahoo ? A.Uri_parse("https://yahoo-proxy-v2.jim-andreou.workers.dev?target=" + A._Uri__uriEncode(2, uri, B.C_Utf8Codec, false)) : A.Uri_parse(uri);
              requestHeaders = null;
              t2 = headers != null;
              if (t2) {
                t3 = type$.String;
                requestHeaders = A.LinkedHashMap_LinkedHashMap$from(headers, t3, t3);
                if (isYahoo) {
                  requestHeaders.remove$1(0, "User-Agent");
                  requestHeaders.remove$1(0, "user-agent");
                  requestHeaders.remove$1(0, "Accept");
                  requestHeaders.remove$1(0, "accept");
                }
              }
              $async$goto = 7;
              return A._asyncAwait(A.get(finalUri, requestHeaders), $async$fetch$2$headers);
            case 7:
              // returning from await.
              response = $async$result;
              if (response.statusCode !== 200) {
                isYahooCookieWall = isYahoo && t1 && response.statusCode === 404;
                if (!isYahooCookieWall) {
                  t1 = A.Exception_Exception("Failed to fetch " + uri + ", got error: " + response.statusCode);
                  throw A.wrapException(t1);
                }
              }
              if (isYahoo) {
                cookieHeader0 = response.headers.$index(0, "x-yahoo-cookie");
                cookieHeader = cookieHeader0 == null ? response.headers.$index(0, "X-Yahoo-Cookie") : cookieHeader0;
                if (cookieHeader != null) {
                  if (t2) {
                    A.print("Raw cookie: " + cookieHeader);
                    headers.$indexSet(0, "x-proxy-cookie", $async$self._cleanCookieHeader$1(cookieHeader));
                    A.print("Cleaned x-proxy-cookie: " + A.S(headers.$index(0, "x-proxy-cookie")));
                    A.print("Successfully captured cookie!");
                  }
                } else {
                  t1 = response.headers;
                  A.print("No x-yahoo-cookie found. Available: " + new A.LinkedHashMapKeysIterable(t1, A._instanceType(t1)._eval$1("LinkedHashMapKeysIterable<1>")).toString$0(0));
                }
              }
              t1 = response;
              value = A.encodingForContentTypeHeader(A._contentTypeForHeaders(t1.headers)).decode$1(t1.bodyBytes);
              if (!isHandshake) {
                t1 = A._asString(cacheKey);
                t2 = A._asString(value);
                t3 = Date.now();
                t4 = $async$self._url_fetcher$_duration._duration;
                durationLo = B.JSInt_methods.$mod(t4, 1000);
                durationHi = B.JSInt_methods._tdivFast$1(t4 - durationLo, 1000);
                microsecond = B.JSInt_methods.$mod(durationLo, 1000);
                t3 = A.DateTime__validate(t3 + B.JSInt_methods._tdivFast$1(durationLo - microsecond, 1000) + durationHi, microsecond, false);
                Date.now();
                $async$self._url_fetcher$_cache._cache$_cache.$indexSet(0, t1, new A.CacheItem(new A.DateTime(t3, microsecond, false), t2, type$.CacheItem_String));
              }
            ...
            case 4:
              ...
              $async$exception = $async$errorStack.pop();
              e = A.unwrapException($async$exception);
              A.print("Failed while fetching url: [" + uri + "], error: " + A.S(e));
      ...
      return A._asyncStartSync($async$fetch$2$headers, $async$completer);
    },
    _getCacheKeyIgnoringCrumb$1(uri) {
      var parsed, queryParams, newUri, t1, exception,
        cacheKey = uri;
      try {
        parsed = A.Uri_parse(uri);
        if (parsed.get$queryParameters().containsKey$1("crumb")) {
          t1 = type$.String;
          queryParams = A.LinkedHashMap_LinkedHashMap$from(parsed.get$queryParameters(), t1, t1);
          J.remove$1$ax(queryParams, "crumb");
          if (queryParams.__js_helper$_length === 0)
            t1 = "";
          else {
            t1 = A._Uri__Uri(null, queryParams)._query;
            if (t1 == null)
              t1 = "";
          }
          newUri = parsed.replace$1$query(t1).get$_text();
          cacheKey = queryParams.__js_helper$_length === 0 && J.endsWith$1$s(newUri, "?") ? J.substring$2$s(newUri, 0, J.get$length$asx(newUri) - 1) : newUri;
        }
      } catch (exception) {
      }
      return cacheKey;
    },
    _cleanCookieHeader$1(rawCookie) {
      var t2, _i, subParts, t3, _i0, trimmed, t4,
        cleanParts = A._setArrayType([], type$.JSArray_String),
        parts = B.JSString_methods.split$1(rawCookie, A.RegExp_RegExp(",(?=[^;]*=)")),
        t1 = type$.String,
        metadata = A.LinkedHashSet_LinkedHashSet$_literal(["expires", "domain", "path", "samesite", "max-age", "secure", "httponly"], t1);
      for (t2 = parts.length, _i = 0; _i < parts.length; parts.length === t2 || (0, A.throwConcurrentModificationError)(parts), ++_i) {
        subParts = parts[_i].split(";");
        for (t3 = subParts.length, _i0 = 0; _i0 < t3; ++_i0) {
          trimmed = B.JSString_methods.trim$0(subParts[_i0]);
          if (B.JSString_methods.contains$1(trimmed, "=")) {
            t4 = trimmed.split("=");
            if (0 >= t4.length)
              return A.ioore(t4, 0);
            if (!metadata.contains$1(0, t4[0].toLowerCase()))
              B.JSArray_methods.add$1(cleanParts, trimmed);
          }
        }
      }
      return A.LinkedHashSet_LinkedHashSet$from(cleanParts, t1).join$1(0, "; ");
    }
  };
  A.YFinance.prototype = {
    fetchMarkets$4$maxDTE$minDTE(ticker, urlFetcher, maxDTE, minDTE) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_Market),
        $async$returnValue, $async$self = this, t2, t3, t4, t5, t6, t7, t8, firstOptionChain, spotMarket, t9, url, results, quote, t10, money, underlying, t11, t12, isMarketOpen, optionChain, firstOptionChain0, expirations, expiration, dte, currentExpirationDate, currentDte, skipChain, _i, t13, optionType, isCall, options, t14, option, t15, lastPrice, t16, t17, lastTradeDate, ask, bid, optionMarket, markets, t1, urlsToFetch, $async$temp1, $async$temp2;
      var $async$fetchMarkets$4$maxDTE$minDTE = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              markets = A._setArrayType([], type$.JSArray_Market);
              t1 = "https://query2.finance.yahoo.com/v7/finance/options/" + ticker + "?crumb=" + $async$self._crumb;
              urlsToFetch = A._setArrayType([t1], type$.JSArray_String);
              A.print("Fetching " + ticker + " ...");
              t2 = type$.Iterable_dynamic, t3 = type$.Venue, t4 = type$.dynamic, t5 = type$.nullable_List_dynamic, t6 = $async$self._headers, t7 = type$.Map_String_dynamic, t1 += "&date=", t8 = type$.int, firstOptionChain = true, spotMarket = null;
            case 3:
              // for condition
              if (!(t9 = urlsToFetch.length, t9 !== 0)) {
                // goto after for
                $async$goto = 4;
                break;
              }
              if (0 >= t9) {
                $async$returnValue = A.ioore(urlsToFetch, -1);
                // goto return
                $async$goto = 1;
                break;
              }
              url = urlsToFetch.pop();
              A.printString("About to fetch an option chain... " + url + ", Headers: " + t6.toString$0(0));
              $async$temp1 = t7;
              $async$temp2 = B.C_JsonCodec;
              $async$goto = 5;
              return A._asyncAwait(urlFetcher.fetch$2$headers(url, t6), $async$fetchMarkets$4$maxDTE$minDTE);
            case 5:
              // returning from await.
              t9 = $async$temp1._as($async$temp2.decode$1($async$result)).$index(0, "optionChain");
              t9 = t5._as(t9 == null ? null : J.$index$asx(t9, "result"));
              results = t9 == null ? null : A.IterableExtension_get_firstOrNull(t9, t4);
              t9 = J.getInterceptor$asx(results);
              quote = t9.$index(results, "quote");
              if (quote == null)
                quote = A.throwExpression(A.StateError$("Did not find quote"));
              t10 = J.getInterceptor$asx(quote);
              money = new A.Commodity(A._asString(t10.$index(quote, "currency")), null);
              underlying = new A.Commodity(A._asString(t10.$index(quote, "symbol")), A.LinkedHashSet_LinkedHashSet$_literal([B.Venue_1], t3));
              t11 = t10.$index(quote, "regularMarketPrice");
              t11.toString;
              A._asDouble(t11);
              t12 = t10.$index(quote, "regularMarketPrice");
              t12.toString;
              A._asDouble(t12);
              spotMarket = new A._DirectMarket(underlying, money, t11, t12);
              if (t11 > t12)
                A.throwExpression(A.ArgumentError$(string$.Bid_pr + spotMarket.toString$0(0), null));
              A.printString("Quote: " + A.S(quote));
              isMarketOpen = J.$eq$(t10.$index(quote, "marketState"), "REGULAR");
              t10 = t10.$index(quote, "regularMarketTime");
              t10.toString;
              t10 = A.DateTime__validate(A._asInt(J.$mul$ns(t10, 1000)), 0, false);
              t11 = t5._as(t9.$index(results, "options"));
              optionChain = t11 == null ? null : A.IterableExtension_get_firstOrNull(t11, t4);
              if (optionChain == null) {
                // goto for condition
                $async$goto = 3;
                break;
              }
              firstOptionChain0 = false;
              if (firstOptionChain) {
                A.printString("First option chain: " + A.S(optionChain));
                t9 = J.cast$1$0$ax(t9.$index(results, "expirationDates"), t8);
                expirations = t9.toSet$0(t9);
                expirations.remove$1(0, J.$index$asx(optionChain, "expirationDate"));
                t9 = Date.now();
                for (t2._as(expirations), t11 = expirations.get$iterator(expirations); t11.moveNext$0();) {
                  expiration = A._asInt(t11.get$current());
                  dte = B.JSInt_methods._tdivFast$1(1000 * (A.DateTime__validate(expiration * 1000, 0, false) - t9), 864e8);
                  if (dte < minDTE)
                    continue;
                  if (dte > maxDTE)
                    continue;
                  B.JSArray_methods.add$1(urlsToFetch, t1 + expiration);
                }
                firstOptionChain = firstOptionChain0;
              }
              t9 = J.getInterceptor$asx(optionChain);
              t11 = A.DateTime__validate(A._asInt(J.$mul$ns(t9.$index(optionChain, "expirationDate"), 1000)), 0, false);
              currentExpirationDate = new A.DateTime(t11, 0, false);
              currentDte = B.JSInt_methods._tdivFast$1(1000 * (t11 - Date.now()), 864e8);
              skipChain = currentDte < minDTE;
              if (currentDte > maxDTE ? true : skipChain) {
                // goto for condition
                $async$goto = 3;
                break;
              }
              for (t11 = [B.Record2_calls_true, B.Record2_puts_false], t12 = !isMarketOpen, _i = 0; _i < 2; ++_i) {
                t13 = t11[_i];
                optionType = t13._0;
                isCall = t13._1;
                options = t9.$index(optionChain, optionType);
                for (t13 = J.get$iterator$ax(t2._as(options == null ? A.throwExpression(A.StateError$("Did not find " + optionType)) : options)), t14 = !isCall; t13.moveNext$0();) {
                  option = t13.get$current();
                  t15 = J.getInterceptor$asx(option);
                  lastPrice = t15.$index(option, "lastPrice");
                  if (lastPrice == null)
                    lastPrice = 0;
                  if (isMarketOpen) {
                    t16 = t15.$index(option, "bid");
                    if (t16 == null)
                      t16 = 0;
                  } else
                    t16 = lastPrice;
                  ...
                  A._asDouble(t17);
                  if (t12) {
                    lastTradeDate = t15.$index(option, "lastTradeDate");
                    if (lastTradeDate == null || B.JSInt_methods._tdivFast$1(1000 * (t10 - A.DateTime__validate(A._asInt(J.$mul$ns(lastTradeDate, 1000)), 0, false)), 60000000) > 20) {
                      A.printString("Skipping option due to old last trade date: " + A.S(option));
                      continue;
                    }
                  }
                  if (t16 > t17) {
                  ...
                  if (bid === 0 || ask === 0) {
                    A.printString("Skipping option " + A.S(t15.$index(option, "contractSymbol")) + " due to bad bid/ask: " + A.S(option));
                    continue;
                  }
                  t16 = bid * 100;
                  t17 = ask * 100;
                  optionMarket = new A._DirectMarket(A.Option$(A._asString(t15.$index(option, "contractSymbol")), 100, currentExpirationDate, isCall, t14, 1, money, A._asDouble(t15.$index(option, "strike")), underlying, A.LinkedHashSet_LinkedHashSet$_literal([B.Venue_1], t3)), new A.Commodity(A._asString(t15.$index(option, "currency")), null), t16, t17);
                  if (t16 > t17)
                    A.throwExpression(A.ArgumentError$(string$.Bid_pr + optionMarket.toString$0(0), null));
                  B.JSArray_methods.add$1(markets, optionMarket);
                }
              }
              // goto for condition
              $async$goto = 3;
            ...
            case 4:
              // after for
              spotMarket.toString;
              B.JSArray_methods.add$1(markets, spotMarket);
              $async$returnValue = markets;
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$fetchMarkets$4$maxDTE$minDTE, $async$completer);
    }
  };
  A.MarketListExtension_whereUnderlyingIs_closure.prototype = {
    call$1(market) {
      var asset = type$.Market._as(market).get$asset(),
        t1 = this.underlying.name;
      if (asset.name !== t1)
        if (asset instanceof A.Expirable)
          t1 = asset.underlying.name === t1;
        else
          t1 = false;
      else
        t1 = true;
  ...
  A.MarketListExtension_coercedToMoney_closure.prototype = {
    call$1(market) {
      return this.helper.marketFor$2$asset$money(type$.Market._as(market).get$asset(), this.money);
    },
    $signature: 48
  };
  A.MarketListExtension_optionsWithStrikeInMoney_closure.prototype = {
    call$1(market) {
      var t1;
      type$.Market._as(market);
      if (market.get$asset() instanceof A.Option)
        t1 = type$.Option._as(market.get$asset()).money.name === this.strikeMoney.name;
      else
        t1 = false;
      return t1;
    },
  ...
  A.MarketListExtension_get_calls_closure.prototype = {
    call$1(market) {
      type$.Market._as(market);
      return market.get$asset() instanceof A.Option && type$.Option._as(market.get$asset()).isCall;
    },
    $signature: 4
  };
  A.MarketListExtension_get_puts_closure.prototype = {
    call$1(market) {
      type$.Market._as(market);
      return market.get$asset() instanceof A.Option && type$.Option._as(market.get$asset()).isPut;
    },
    $signature: 4
  };
  A.MarketListExtension_sortByExpiration_closure.prototype = {
    call$1(expirable) {
      return expirable.expiration;
    },
    $signature: 23
  };
  A.MarketListExtension_sortByStrike_closure.prototype = {
    call$1(expirable) {
      return type$.Option._as(expirable).strike;
    },
    $signature: 24
  };
  A.MarketListExtension__sort_closure.prototype = {
    call$1(market) {
      return type$.Market._as(market).get$asset() instanceof A.Expirable;
    },
    $signature: 4
  };
  A.MarketListExtension__sort_closure0.prototype = {
    call$2(a, b) {
      var t2, t3, comparison,
        t1 = type$.Record_2_int_and_Market;
      t1._as(a);
      t1._as(b);
      t1 = this.keyExtractor;
      t2 = type$.Expirable;
      t3 = t1.call$1(t2._as(a._1.get$asset()));
      t2 = t1.call$1(t2._as(b._1.get$asset()));
      t1 = this.T;
      A.checkTypeBound(t1, t1._eval$1("Comparable<0>"), "T", "compare");
      comparison = J.compareTo$1$ns(t1._as(t3), t1._as(t2));
      if (this.order === B.Order_1)
        comparison = -comparison;
      if (comparison !== 0)
        return comparison;
      return B.JSInt_methods.compareTo$1(a._0, b._0);
    },
    $signature: 51
  };
  A.MarketListExtension__sort_closure1.prototype = {
    call$1(indexedMarket) {
      return type$.Record_2_int_and_Market._as(indexedMarket)._1;
    },
    $signature: 52
  };
  A.MarketListExtension_groupByExpiration_closure.prototype = {
    call$1(expirable) {
      return expirable.expiration;
    },
    $signature: 23
  };
  A.MarketListExtension_groupByStrike_closure.prototype = {
    call$1(expirable) {
      return type$.Option._as(expirable).strike;
    },
    $signature: 24
  };
  A.MarketListExtension__groupBy_closure.prototype = {
    call$1(market) {
      return type$.Market._as(market).get$asset() instanceof A.Expirable;
    },
    $signature: 4
  };
  A.MarketListExtension__groupBy_closure0.prototype = {
    call$1(market) {
      return this.keyExtractor.call$1(type$.Expirable._as(type$.Market._as(market).get$asset()));
    },
    $signature() {
      return this.T._eval$1("0(Market)");
    }
  };
  A.MarketsMapExtension_mapValues_closure.prototype = {
    call$2(key, markets) {
      var t1 = this.T;
      return new A.MapEntry(t1._as(key), this.fn.call$1(type$.Iterable_Market._as(markets)), t1._eval$1("@<0>")._bind$1(this.R)._eval$1("MapEntry<1,2>"));
    },
    $signature() {
      return this.T._eval$1("@<0>")._bind$1(this.R)._eval$1("MapEntry<1,2>(1,Iterable<Market>)");
    }
  };
  A.Market.prototype = {
    toAsset$2(line, slippage) {
      var lineAsset, t1, s, t2, t3, _this = this;
      $label0$0: {
        lineAsset = line.asset;
        t1 = false;
        s = line.size;
        t2 = _this.get$money();
        t1 = lineAsset.name === t2.name;
        if (t1) {
          t1 = _this.get$asset();
          t2 = _this.get$bidPrice();
          t3 = _this._slippage$1(slippage);
          if (typeof s !== "number")
            return s.$div();
          t3 = new A.Line(t1, s / (t2 + t3));
          t1 = t3;
          break $label0$0;
        }
        t1 = A.throwExpression(A.ArgumentError$("Expected money [" + _this.get$money().toString$0(0) + "], got: " + lineAsset.toString$0(0), null));
      }
      return t1;
    },
    toAsset$1(line) {
      return this.toAsset$2(line, 0.5);
    },
    toMoney$2(line, slippage) {
      var lineAsset, t1, s, t2, t3, _this = this;
      $label0$0: {
        lineAsset = line.asset;
        t1 = false;
        ...
        t1 = A.throwExpression(A.ArgumentError$("Expected asset [" + _this.get$asset().toString$0(0) + "], got: " + lineAsset.toString$0(0), null));
      }
      return t1;
    },
    _slippage$1(slippageRatio) {
      if (!(slippageRatio >= 0 && slippageRatio <= 1))
        throw A.wrapException(A.ArgumentError$("Slippage ratio must be in [0, 1], was: " + A.S(slippageRatio), null));
      return (this.get$askPrice() - this.get$bidPrice()) * slippageRatio;
    },
    get$relativeSpread() {
      var _this = this;
      return (_this.get$askPrice() - _this.get$bidPrice()) / ((_this.get$bidPrice() + _this.get$askPrice()) / 2);
    },
    get$reverse() {
      if (this instanceof A._InverseMarket)
        return this._market;
      return new A._InverseMarket(this);
    },
    decompose$0() {
      return A._setArrayType([this], type$.JSArray_Market);
    },
    toString$0(_) {
      var t7, _this = this,
        t1 = _this.get$asset().toString$0(0),
        t2 = _this.get$bidPrice(),
        t3 = _this.get$money().toString$0(0),
        t4 = _this.get$askPrice(),
        t5 = _this.get$money().toString$0(0),
        t6 = type$.Asset;
      t6 = A.FollowedByIterable_FollowedByIterable$firstEfficient(A._setArrayType([_this.get$asset()], type$.JSArray_Asset), type$.Iterable_Asset._as(J.map$1$1$ax(_this.decompose$0(), new A.Market_toString_closure(), t6)), t6);
      t7 = A._instanceType(t6);
      return t1 + ", bid: " + A.S(t2) + " " + t3 + ", ask: " + A.S(t4) + " " + t5 + " [" + A.MappedIterable_MappedIterable(t6, t7._eval$1("String(Iterable.E)")._as(new A.Market_toString_closure0()), t7._eval$1("Iterable.E"), type$.String).join$1(0, "->") + "]";
    }
  };
  A.Market_toString_closure.prototype = {
    call$1(m) {
      return type$.Market._as(m).get$money();
    },
    $signature: 53
  };
  A.Market_toString_closure0.prototype = {
    call$1(a) {
      return type$.Asset._as(a).toString$0(0);
    },
    $signature: 54
  };
  A._DirectMarket.prototype = {
    get$asset() {
      return this.asset;
    },
    get$money() {
  ...
  A._IdentityMarket.prototype = {
    decompose$0() {
      return A._setArrayType([], type$.JSArray_Market);
    }
  };
  A._InverseMarket.prototype = {
    get$asset() {
      return this._market.get$money();
    },
    get$money() {
      return this._market.get$asset();
    },
    get$bidPrice() {
      return 1 / this._market.get$askPrice();
    },
    get$askPrice() {
      return 1 / this._market.get$bidPrice();
    }
  };
  A._SyntheticMarket.prototype = {
    get$asset() {
      return this._a2bMarket.get$asset();
    },
    get$money() {
      return this._b2cMarket.get$money();
    },
    get$bidPrice() {
      return this._a2bMarket.get$bidPrice() * this._b2cMarket.get$bidPrice();
    },
    get$askPrice() {
      return this._a2bMarket.get$askPrice() * this._b2cMarket.get$askPrice();
    },
    decompose$0() {
      return J.followedBy$1$ax(this._a2bMarket.decompose$0(), this._b2cMarket.decompose$0());
    }
  };
  A.Order.prototype = {
    _enumToString$0() {
  ...
  A.Oracle.prototype = {
    markToMarket$2$money$position(money, position) {
      return A._MergedPosition$(new A.MappedListIterable(A._setArrayType([position], type$.JSArray_Line), type$.Position_Function_Line._as(new A.Oracle_markToMarket_closure(this, money, 0.5)), type$.MappedListIterable_Line_Position)).singleton$1(money);
    },
    intrinsicValue$2$money$position(money, position) {
      return A._MergedPosition$(J.map$1$1$ax(position.decompose$0(), new A.Oracle_intrinsicValue_closure(this), type$.Line).map$1$1(0, new A.Oracle_intrinsicValue_closure0(this, money), type$.Position)).singleton$1(money);
    }
  };
  A.Oracle_markToMarket_closure.prototype = {
    call$1(line) {
      type$.Line._as(line);
      return this.$this.marketFor$2$asset$money(line.asset, this.money).toMoney$2(line, this.slippage);
    },
    $signature: 6
  };
  A.Oracle_intrinsicValue_closure.prototype = {
    call$1(line) {
      var _0_1, t1, _0_4, underlying, strikeMoney, t2;
      type$.Line._as(line);
      $label0$0: {
        _0_1 = line.asset;
        if (_0_1 instanceof A.Commodity) {
          t1 = line;
          break $label0$0;
        }
        if (_0_1 instanceof A.DatedFuture) {
          _0_4 = _0_1.underlying;
          underlying = _0_4;
          t1 = new A.Line(underlying, line.size);
          break $label0$0;
        }
        if (_0_1 instanceof A.Option) {
          _0_4 = _0_1.underlying;
          underlying = _0_4;
          strikeMoney = _0_1.money;
          t1 = _0_1.isPut ? 1 : -1;
          t2 = this.$this.marketFor$2$asset$money(underlying, strikeMoney);
          t2 = new A.Line(strikeMoney, line.size * _0_1.contractLot * Math.max(0, t1 * (_0_1.strike - (t2.get$bidPrice() + t2.get$askPrice()) / 2)));
          t1 = t2;
          break $label0$0;
        }
        t1 = A.throwExpression(A.AssertionError$("Unexpected asset from decompose(): " + _0_1.toString$0(0)));
      }
      return t1;
    },
    $signature: 6
  };
  A.Oracle_intrinsicValue_closure0.prototype = {
    call$1(line) {
      return this.$this.markToMarket$2$money$position(this.money, type$.Line._as(line));
    },
    $signature: 6
  };
  A.ArchOracle.prototype = {};
  A._RealMarketsOracle.prototype = {
    _RealMarketsOracle$1(allMarkets) {
      var t1, t2, t3, t4, t5, _i, m, t6, t7;
      for (t1 = J.get$iterator$ax(this.allMarkets), t2 = this._markets, t3 = type$.Asset, t4 = type$.Market; t1.moveNext$0();) {
        t5 = t1.get$current();
        for (t5 = [t5, t5.get$reverse()], _i = 0; _i < 2; ++_i) {
          m = t5[_i];
          t6 = m.get$asset();
          t7 = t2.$index(0, t6);
          if (t7 == null) {
            t7 = A.HashMap_HashMap(t3, t4);
            t2.$indexSet(0, t6, t7);
            t6 = t7;
          } else
            t6 = t7;
          t6.$indexSet(0, m.get$money(), m);
        }
      }
    },
    marketFor$2$asset$money(asset, money) {
      var visitedAssets, candidateMarkets, t2, t3, t4, t5, visitingMarket, nextMarkets, maybeCandidateMarket, t6, _null = null,
        t1 = this._cache,
        cachedResult = t1.$index(0, new A._Record_2(asset, money));
      if (cachedResult != null)
        return cachedResult;
      visitedAssets = A.HashSet_HashSet(type$.Asset);
      candidateMarkets = A.SplayTreeSet$(new A._RealMarketsOracle_marketFor_closure(), _null, type$.Market);
      t2 = candidateMarkets.$ti._precomputed1;
      candidateMarkets._add$1(t2._as(A._IdentityMarket$(asset)));
      for (t3 = this._markets; t4 = candidateMarkets._root, t5 = t4 == null, !t5;) {
        if (t5)
          A.throwExpression(A.IterableElementError_noElement());
        t4 = candidateMarkets._splayMin$1(t4);
        candidateMarkets._root = t4;
        visitingMarket = t4.key;
        candidateMarkets.remove$1(0, visitingMarket);
        if (visitingMarket.get$money().$eq(0, money)) {
          t1.$indexSet(0, new A._Record_2(asset, money), visitingMarket);
          return visitingMarket;
        }
        visitedAssets.add$1(0, visitingMarket.get$money());
        nextMarkets = t3.$index(0, visitingMarket.get$money());
        if (nextMarkets != null)
          for (t4 = nextMarkets.get$entries(), t4 = t4.get$iterator(t4); t4.moveNext$0();) {
            maybeCandidateMarket = t4.get$current().value;
            if (!visitedAssets.contains$1(0, maybeCandidateMarket.get$money())) {
              t5 = visitingMarket.get$money();
              t6 = maybeCandidateMarket.get$asset();
              if (t5.name !== t6.name)
                A.throwExpression(A.ArgumentError$("The <money> of the first market: " + visitingMarket.toString$0(0) + ", must be the <asset> of the second market: " + maybeCandidateMarket.toString$0(0), _null));
              t5 = visitingMarket.get$asset();
              t6 = maybeCandidateMarket.get$money();
              if (t5.name === t6.name)
                A.throwExpression(A.ArgumentError$("The <asset> of the first market: " + visitingMarket.toString$0(0) + ", cannot also be the <money> of the second market: " + maybeCandidateMarket.toString$0(0), _null));
              candidateMarkets._add$1(t2._as(new A._SyntheticMarket(visitingMarket, maybeCandidateMarket)));
            }
          }
      }
      throw A.wrapException(A.ArgumentError$("Can't create a market from " + asset.toString$0(0) + " to " + money.toString$0(0), _null));
    }
  };
  A._RealMarketsOracle_marketFor_closure.prototype = {
    call$2(a, b) {
      var comparison,
        t1 = type$.Market;
      t1._as(a);
      t1._as(b);
      comparison = B.JSNumber_methods.compareTo$1(a.get$relativeSpread(), b.get$relativeSpread());
      if (comparison !== 0)
        return comparison;
      comparison = B.JSString_methods.compareTo$1(a.get$asset().name, b.get$asset().name);
      if (comparison !== 0)
        return comparison;
      return B.JSString_methods.compareTo$1(a.get$money().name, b.get$money().name);
    },
    $signature: 55
  };
  A.SimulatedOracle.prototype = {
    marketFor$2$asset$money(asset, money) {
      var t1, price;
      if (asset.name === money.name)
        return A._IdentityMarket$(asset);
      t1 = this._prices;
      price = t1.$index(0, new A._Record_2(asset, money));
      if (price == null)
        throw A.wrapException(A.StateError$("Price was requested for asset " + asset.toString$0(0) + " and money " + money.toString$0(0) + " but no such price was configured via setPrice(). Known prices: " + t1.toString$0(0)));
      return A.Market_Market$create(price, asset, price, money);
    }
  };
  A.PositionAnalyzer.prototype = {
    PositionAnalyzer$3$money$underlying(position, money, underlying) {
      var t2, t3, t4, t5, t6, innerAsset, t7, priceToValue, prevPrice, prevPrice0, valueAtMinPrice, valueAtMaxPrice, _this = this, _null = null,
        _s16_ = ") must be finite",
        expirations = A.LinkedHashSet_LinkedHashSet$_empty(type$.DateTime),
        t1 = type$.double,
        interestingPoints = A.SplayTreeSet$(_null, _null, t1);
      for (t2 = _this.position, t3 = J.get$iterator$ax(t2.decompose$0()), t4 = interestingPoints.$ti, t5 = t4._precomputed1, t6 = _this.money; t3.moveNext$0();) {
        innerAsset = t3.get$current().asset;
        if (innerAsset instanceof A.Expirable) {
          expirations.add$1(0, innerAsset.expiration);
          if (expirations._collection$_length >= 2)
            throw A.wrapException(A.ArgumentError$("At least 2 different option expirations involved in position: " + t2.toString$0(0) + ", impossible to analyze", _null));
        }
        if (innerAsset instanceof A.Option) {
          t7 = innerAsset.money;
          if (t7.name !== t6.name)
            throw A.wrapException(A.ArgumentError$("A PositionAnalyzer(money=" + t6.toString$0(0) + ") cannot analyze an option " + innerAsset.toString$0(0) + " because its strike is of a different money: " + t7.toString$0(0), _null));
          interestingPoints._add$1(t5._as(innerAsset.strike));
        }
      }
      priceToValue = new A.PositionAnalyzer_priceToValue(_this, new A.SimulatedOracle(A.HashMap_HashMap(type$.Record_2_Asset_and_Commodity, t1)));
      for (t1 = new A._SplayTreeKeyIterator(interestingPoints, A._setArrayType([], t4._eval$1("JSArray<_SplayTreeSetNode<1>>")), interestingPoints._splayCount, t4._eval$1("_SplayTreeKeyIterator<1,_SplayTreeSetNode<1>>")), t2 = _this._segments, prevPrice = 0; t1.moveNext$0(); prevPrice = prevPrice0) {
        prevPrice0 = t1.get$current();
        if (!isFinite(prevPrice0))
          A.throwExpression(A.ArgumentError$("maxPrice (" + A.S(prevPrice0) + _s16_, _null));
        valueAtMinPrice = priceToValue.call$1(prevPrice);
        valueAtMaxPrice = priceToValue.call$1(prevPrice0);
        if (!isFinite(prevPrice))
          A.throwExpression(A.ArgumentError$("minPrice (" + A.S(prevPrice) + _s16_, _null));
        if (prevPrice >= prevPrice0)
          A.throwExpression(A.ArgumentError$("minPrice (" + A.S(prevPrice) + ") >= maxPrice (" + A.S(prevPrice0) + ")", _null));
        B.JSArray_methods.add$1(t2, new A._PnLSegment(prevPrice, prevPrice0, valueAtMinPrice, valueAtMaxPrice, (valueAtMaxPrice - valueAtMinPrice) / (prevPrice0 - prevPrice)));
      }
      B.JSArray_methods.add$1(t2, A._PnLSegment__PnLSegment$open(priceToValue, prevPrice));
    },
    get$minValue() {
      var t1 = this._segments,
        t2 = A._arrayInstanceType(t1);
      t2 = A.IterableDoubleExtension_get_minOrNull(new A.MappedListIterable(t1, t2._eval$1("double(1)")._as(new A.PositionAnalyzer_minValue_closure()), t2._eval$1("MappedListIterable<1,double>")));
      return t2 == null ? A.throwExpression(A.StateError$("No element")) : t2;
    },
    get$maxValue() {
      var t1 = this._segments,
        t2 = A._arrayInstanceType(t1);
      t2 = A.IterableDoubleExtension_get_maxOrNull(new A.MappedListIterable(t1, t2._eval$1("double(1)")._as(new A.PositionAnalyzer_maxValue_closure()), t2._eval$1("MappedListIterable<1,double>")));
      return t2 == null ? A.throwExpression(A.StateError$("No element")) : t2;
    },
    whereValueIs$1(value) {
      var t1 = this._segments,
        t2 = A._arrayInstanceType(t1);
      return A.PriceRange__mergeAdjacents(new A.NonNullsIterable(new A.MappedListIterable(t1, t2._eval$1("PriceRange?(1)")._as(new A.PositionAnalyzer_whereValueIs_closure(value)), t2._eval$1("MappedListIterable<1,PriceRange?>")), type$.NonNullsIterable_PriceRange));
    },
    toString$0(_) {
      var _this = this;
      return "PositionAnalyzer(position: " + _this.position.toString$0(0) + ", underlying: " + _this.underlying.toString$0(0) + ", money: " + _this.money.toString$0(0) + ", minValue: " + A.S(_this.get$minValue()) + ", maxValue: " + A.S(_this.get$maxValue()) + ", breakevens: " + A.S(_this.whereValueIs$1(0)) + "), segments: " + A.S(_this._segments);
    }
  };
  A.PositionAnalyzer_priceToValue.prototype = {
    call$1(price) {
      var t1 = this.oracle,
        t2 = this.$this,
        t3 = t2.money;
      t1._prices.$indexSet(0, new A._Record_2(t2.underlying, t3), price);
      return t1.intrinsicValue$2$money$position(t3, t2.position).size;
    },
    $signature: 22
  };
  A.PositionAnalyzer_minValue_closure.prototype = {
    call$1(segment) {
      var t1;
      type$._PnLSegment._as(segment);
      t1 = segment.___PnLSegment_delta_F;
      t1 === $ && A.throwLateFieldNI("delta");
      return segment.minOrMaxValue$1(t1);
    },
    $signature: 25
  };
  A.PositionAnalyzer_maxValue_closure.prototype = {
    call$1(segment) {
      var t1;
      type$._PnLSegment._as(segment);
      t1 = segment.___PnLSegment_delta_F;
  ...
  A.PositionAnalyzer_whereValueIs_closure.prototype = {
    call$1(segment) {
      return type$._PnLSegment._as(segment).whereValueIs$1(this.value);
    },
    $signature: 57
  };
  A.PriceRange.prototype = {
    toString$0(_) {
      var t1 = this.fromPrice,
        t2 = this.toPrice,
        t3 = A.S(t1);
      return t1 === t2 ? t3 : "[" + t3 + ".." + A.S(t2) + "]";
    }
  };
  A.PriceRange__mergeAdjacents_closure.prototype = {
    call$2(previous, next) {
      var t1, t2, _0_1, _0_7, rest, t3, _0_6, t4, _0_7_isSet, last, _null = null;
      type$.List_PriceRange._as(previous);
      t1 = type$.PriceRange;
      t1._as(next);
      $label0$0: {
        t2 = J.getInterceptor$asx(previous);
        _0_1 = t2.get$length(previous);
        if (_0_1 <= 0) {
          t1 = A._setArrayType([next], type$.JSArray_PriceRange);
          break $label0$0;
        }
        _0_7 = _null;
        rest = _null;
        t3 = false;
        if (_0_1 >= 1) {
          _0_6 = t2.sublist$2(previous, 0, _0_1 - 1);
          t4 = _0_6;
          _0_7_isSet = type$.List_dynamic._is(t4);
          if (_0_7_isSet) {
            _0_7 = t2.$index(previous, _0_1 - 1);
            t3 = _0_7;
            t3 = t3 instanceof A.PriceRange;
            rest = _0_6;
          }
        } else
          _0_7_isSet = false;
        if (t3) {
          ...
          t2 = last.toPrice;
          if (t2 >= next.fromPrice) {
            t1 = A.List_List$_of(rest, t1);
            t1.push(new A.PriceRange(last.fromPrice, Math.max(t2, next.toPrice)));
          } else {
            t1 = A.List_List$_of(rest, t1);
            t1.push(last);
            t1.push(next);
  ...
  A._PnLSegment.prototype = {
    minOrMaxValue$1(delta) {
      var t1;
      $label0$0: {
        if (-1 === J.get$sign$in(delta)) {
          t1 = this.___PnLSegment_valueAtMaxPrice_F;
          t1 === $ && A.throwLateFieldNI("valueAtMaxPrice");
          break $label0$0;
        }
        t1 = this.___PnLSegment_valueAtMinPrice_F;
        t1 === $ && A.throwLateFieldNI("valueAtMinPrice");
        break $label0$0;
      }
      return t1;
    },
    whereValueIs$1(value) {
      var t2, t3, diffFromValueAtMinPrice, _this = this,
        _s15_ = "valueAtMinPrice",
        t1 = _this.___PnLSegment_delta_F;
      t1 === $ && A.throwLateFieldNI("delta");
      if (t1 === 0) {
        t1 = _this.___PnLSegment_valueAtMinPrice_F;
        t1 === $ && A.throwLateFieldNI(_s15_);
        return t1 === value ? new A.PriceRange(_this.minPrice, _this.maxPrice) : null;
      }
      t2 = _this.___PnLSegment_valueAtMinPrice_F;
      t2 === $ && A.throwLateFieldNI(_s15_);
      if (value === t2) {
        t1 = _this.minPrice;
        return new A.PriceRange(t1, t1);
      }
      t3 = _this.___PnLSegment_valueAtMaxPrice_F;
      t3 === $ && A.throwLateFieldNI("valueAtMaxPrice");
      if (value === t3) {
        t1 = _this.maxPrice;
        return new A.PriceRange(t1, t1);
      }
      diffFromValueAtMinPrice = t2 - value;
      if (J.get$sign$in(diffFromValueAtMinPrice) === J.get$sign$in(t3 - value))
        return null;
      t1 = _this.minPrice - diffFromValueAtMinPrice / t1;
      return new A.PriceRange(t1, t1);
    },
    toString$0(_) {
      var _this = this,
        t1 = _this.___PnLSegment_delta_F;
      t1 === $ && A.throwLateFieldNI("delta");
      return "[(" + A.S(_this.minPrice) + ".." + A.S(_this.maxPrice) + "), minValue=" + A.S(_this.minOrMaxValue$1(t1)) + ", maxValue=" + A.S(_this.minOrMaxValue$1(-t1)) + ", delta=" + A.S(t1) + "]";
    }
  };
  A._OptionStratAssetRenderer.prototype = {
    render$1(asset) {
      if (!asset.get$venues().contains$1(0, B.Venue_1))
        throw A.wrapException(A.ArgumentError$("Asset does not support OptionStrat venue: " + asset.toString$0(0), null));
      if (asset instanceof A.Commodity || asset instanceof A.Option)
        return "https://finance.yahoo.com/quote/" + asset.name + "/";
      throw A.wrapException(A.ArgumentError$("Asset must be a Commodity or an Option: " + asset.toString$0(0), null));
    }
  };
  A._DeribitAssetRenderer.prototype = {
    render$1(asset) {
      var underlying, t1, t2;
      if (!asset.get$venues().contains$1(0, B.Venue_0))
        throw A.wrapException(A.ArgumentError$("Asset does not support Deribit venue: " + asset.toString$0(0), null));
      if (asset instanceof A.Commodity)
        return "https://www.deribit.com/spot/" + asset.name + "_USDT";
      if (asset instanceof A.DatedFuture)
        return "https://www.deribit.com/futures/" + asset.name;
      if (asset instanceof A.Option) {
        underlying = asset.underlying.name;
        t1 = asset.expiration;
        t2 = A.Primitives_getMonth(t1);
        if (!(t2 < 13))
          return A.ioore(B.List_jTS, t2);
        return "https://www.deribit.com/options/" + underlying + "/" + underlying + "-" + ("" + A.Primitives_getDay(t1) + B.List_jTS[t2] + B.JSString_methods.padLeft$2(B.JSInt_methods.toString$0(B.JSInt_methods.$mod(A.Primitives_getYear(t1), 100)), 2, "0")) + "/" + asset.name;
      }
      throw A.wrapException(A.ArgumentError$("Asset must be a Commodity, DatedFuture or an Option: " + asset.toString$0(0), null));
    }
  };
  A.PositionRenderer_tryRenderFirst_closure.prototype = {
    call$1(l) {
      return type$.Line._as(l).asset.get$venues();
    },
    $signature: 89
  };
  A._OptionStratPositionRenderer.prototype = {
    _formatOptionStratName$1($name) {
      var t1, t2, t3, strike,
        match = A.RegExp_RegExp("^(.*[CP])(\\d{8})$").firstMatch$1($name);
      if (match != null) {
        t1 = match._match;
        t2 = t1.length;
        if (1 >= t2)
        ...
        t1 = t1[2];
        t1.toString;
        strike = A.int_parse(t1) / 1000;
        t1 = B.JSNumber_methods.toInt$0(strike);
        return t3 + (strike === t1 ? B.JSInt_methods.toString$0(t1) : B.JSNumber_methods.toString$0(strike));
      }
      return $name;
    },
    render$1(position) {
      var t1, underlyingName, t2, t3, t4, currentUnderlying, parts, _i, line, sizeStr, _null = null,
        validLines = A._setArrayType([], type$.JSArray_Line);
      for (t1 = J.get$iterator$ax(position.decompose$0()), underlyingName = _null; t1.moveNext$0();) {
        t2 = t1.get$current();
        t3 = t2.asset;
        t4 = t3._venues;
        if (!(t4 == null ? B.Set_empty : t4).contains$1(0, B.Venue_1))
          continue;
        if (t3 instanceof A.Commodity)
          currentUnderlying = t3.name;
        else if (t3 instanceof A.Option)
          currentUnderlying = t3.underlying.name;
        else
          throw A.wrapException(A.ArgumentError$("Asset must be a Commodity or Option: " + t3.toString$0(0), _null));
        if (underlyingName == null)
          underlyingName = currentUnderlying;
        else if (underlyingName !== currentUnderlying)
          throw A.wrapException(A.ArgumentError$("Position contains multiple underlyings: " + underlyingName + " and " + currentUnderlying, _null));
        B.JSArray_methods.add$1(validLines, t2);
      }
      if (underlyingName == null || validLines.length === 0)
        throw A.wrapException(A.ArgumentError$("No valid OptionStrat assets found in position.", _null));
      parts = A._setArrayType([], type$.JSArray_String);
      for (t1 = validLines.length, _i = 0; _i < validLines.length; validLines.length === t1 || (0, A.throwConcurrentModificationError)(validLines), ++_i) {
        line = validLines[_i];
        sizeStr = B.JSInt_methods.toString$0(B.JSNumber_methods.round$0(line.size));
        t2 = line.asset;
        if (t2 instanceof A.Commodity)
          B.JSArray_methods.add$1(parts, t2.name + "x" + sizeStr);
        else if (t2 instanceof A.Option)
          B.JSArray_methods.add$1(parts, "." + this._formatOptionStratName$1(t2.name) + "x" + sizeStr);
      }
      return "https://optionstrat.com/build/custom/" + underlyingName + "/" + B.JSArray_methods.join$1(parts, ",");
    }
  };
  A.CoveredCall.prototype = {
    toJson$0() {
      var t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, _this = this,
        _s16_ = "premiumToReceive",
        t1 = _this.expiration,
        t2 = A._formatDate(t1),
        t3 = _this.strikePrice,
        t4 = t3.absolute,
        t5 = A._formatDouble(t4),
        t6 = A.PositionRenderer_tryRenderFirst(_this.strategy),
        t7 = _this.__CoveredCall_moneyYield_F;
      t7 === $ && A.throwLateFieldNI("moneyYield");
      t8 = _this.__CoveredCall_underlyingYield_F;
      t8 === $ && A.throwLateFieldNI("underlyingYield");
      t9 = _this.underlying;
      t10 = A.AssetRenderer_tryRenderFirst(t9);
      t11 = _this.__CoveredCall_premiumToReceive_F;
      t11 === $ && A.throwLateFieldNI(_s16_);
      t12 = _this.__CoveredCall_moneyProfit_F;
      t12 === $ && A.throwLateFieldNI("moneyProfit");
      t13 = _this.optionLeg;
      t14 = t13.asset;
      t15 = A.AssetRenderer_tryRenderFirst(t14);
      t16 = B.JSInt_methods._tdivFast$1(t1.difference$1(new A.DateTime(Date.now(), 0, false))._duration, 864e8);
      t1 = A.DateTimeAsExpirationExtension_get_formattedDate(t1);
      t17 = _this.__CoveredCall_breakEvenVsFullUnderlying_F;
      t17 === $ && A.throwLateFieldNI("breakEvenVsFullUnderlying");
      t18 = _this.__CoveredCall_breakEvenVsFullMoney_F;
      t18 === $ && A.throwLateFieldNI("breakEvenVsFullMoney");
      return A.LinkedHashMap_LinkedHashMap$_literal(["id", t2 + "~" + t5, "strategyType", "coveredCall", "strategyURL", t6, "moneyYield", t7, "underlyingYield", t8, "underlying", t9.name, "underlyingURL", t10, "underlyingToBuy", _this.underlyingToBuy.size, _s16_, t11.size, "money", _this.money.name, "moneySize", _this.moneyLeg.size, "moneyProfit", t12, "spotPrice", _this.spotPrice, "call", t14.name, "callURL", t15, "callSize", t13.size, "DTE", t16, "formattedDate", t1, "strikeAbsolute", t4, "strikeRelative", t3.relative, "breakEvenVsFullUnderlyingAbsolute", t17.absolute, "breakEvenVsFullUnderlyingRelative", t17.relative, "breakEvenVsFullMoneyAbsolute", t18.absolute, "breakEvenVsFullMoneyRelative", t18.relative, "moneyProbability", _this.moneyProbability, "underlyingProbability", _this.underlyingProbability], type$.String, type$.dynamic);
    },
    toString$0(_) {
      return B.C_JsonCodec.encode$2$toEncodable(this, null);
    }
  };
  A.LongCall.prototype = {
    toJson$0() {
      var t8, t9, t10, t11, t12, t13, t14, t15, _this = this,
        t1 = _this.expiration,
        t2 = A._formatDate(t1),
        t3 = _this.strikePrice,
        t4 = t3.absolute,
        t5 = A._formatDouble(t4),
        t6 = A.PositionRenderer_tryRenderFirst(_this.strategy),
        t7 = _this.__LongCall_maxLeverage_F;
      t7 === $ && A.throwLateFieldNI("maxLeverage");
      t8 = _this.underlying;
      t9 = A.AssetRenderer_tryRenderFirst(t8);
      t10 = _this.optionLeg;
      t11 = t10.asset;
      t12 = A.AssetRenderer_tryRenderFirst(t11);
      t13 = B.JSInt_methods._tdivFast$1(t1.difference$1(new A.DateTime(Date.now(), 0, false))._duration, 864e8);
      t1 = A.DateTimeAsExpirationExtension_get_formattedDate(t1);
      t14 = _this.__LongCall_breakEvenVsFullUnderlying_F;
      t14 === $ && A.throwLateFieldNI("breakEvenVsFullUnderlying");
      t15 = _this.__LongCall_breakEvenVsFullMoney_F;
      t15 === $ && A.throwLateFieldNI("breakEvenVsFullMoney");
      return A.LinkedHashMap_LinkedHashMap$_literal(["id", t2 + "~" + t5 + "~C", "strategyType", "longCall", "strategyURL", t6, "maxLeverage", t7, "underlying", t8.name, "underlyingURL", t9, "costInUnderlying", _this.costInUnderlying.size, "moneySize", _this.moneyLeg.size, "money", _this.money.name, "spotPrice", _this.spotPrice, "call", t11.name, "callURL", t12, "callSize", t10.size, "DTE", t13, "formattedDate", t1, "strikeAbsolute", t4, "strikeRelative", t3.relative, "breakEvenVsFullUnderlyingAbsolute", t14.absolute, "breakEvenVsFullUnderlyingRelative", t14.relative, "breakEvenVsFullMoneyAbsolute", t15.absolute, "breakEvenVsFullMoneyRelative", t15.relative], type$.String, type$.dynamic);
    },
    toString$0(_) {
      return B.C_JsonCodec.encode$2$toEncodable(this, null);
    }
  ...
  A.LongPut.prototype = {
    toJson$0() {
      var t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, _this = this,
        ...
        t5 = A._formatDouble(t4),
        t6 = A.PositionRenderer_tryRenderFirst(_this.strategy),
        t7 = _this.__LongPut_maxLeverage_F;
      t7 === $ && A.throwLateFieldNI("maxLeverage");
      t8 = _this.__LongPut_maxMoneyYield_F;
      t8 === $ && A.throwLateFieldNI("maxMoneyYield");
      t9 = _this.__LongPut_maxMoneyProfit_F;
      t9 === $ && A.throwLateFieldNI("maxMoneyProfit");
      t10 = _this.underlying;
      t11 = A.AssetRenderer_tryRenderFirst(t10);
      t12 = _this.optionLeg;
      t13 = t12.asset;
      t14 = A.AssetRenderer_tryRenderFirst(t13);
      t15 = B.JSInt_methods._tdivFast$1(t1.difference$1(new A.DateTime(Date.now(), 0, false))._duration, 864e8);
      t1 = A.DateTimeAsExpirationExtension_get_formattedDate(t1);
      t16 = _this.__LongPut_breakEvenVsFullUnderlying_F;
      t16 === $ && A.throwLateFieldNI("breakEvenVsFullUnderlying");
      t17 = _this.__LongPut_breakEvenVsFullMoney_F;
      t17 === $ && A.throwLateFieldNI("breakEvenVsFullMoney");
      return A.LinkedHashMap_LinkedHashMap$_literal(["id", t2 + "~" + t5 + "~P", "strategyType", "longPut", "strategyURL", t6, "maxLeverage", t7, "maxMoneyYield", t8, "maxMoneyProfit", t9, "underlying", t10.name, "underlyingURL", t11, "costInUnderlying", _this.costInUnderlying.size, "moneySize", _this.moneyLeg.size, "money", _this.money.name, "spotPrice", _this.spotPrice, "put", t13.name, "putURL", t14, "putSize", t12.size, "DTE", t15, "formattedDate", t1, "strikeAbsolute", t4, "strikeRelative", t3.relative, "breakEvenVsFullUnderlyingAbsolute", t16.absolute, "breakEvenVsFullUnderlyingRelative", t16.relative, "breakEvenVsFullMoneyAbsolute", t17.absolute, "breakEvenVsFullMoneyRelative", t17.relative], type$.String, type$.dynamic);
    },
    toString$0(_) {
      return B.C_JsonCodec.encode$2$toEncodable(this, null);
    }
  };
  A.Straddle.prototype = {
    toJson$0() {
      var t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, _this = this,
        t1 = _this.expiration,
        t2 = A._formatDate(t1),
        t3 = _this.strikePrice,
        t4 = t3.absolute,
        ...
        t6 = A.PositionRenderer_tryRenderFirst(_this.strategy),
        t7 = _this.underlying,
        t8 = A.AssetRenderer_tryRenderFirst(t7),
        t9 = _this.money,
        t10 = _this.callLeg,
        t11 = t10.asset,
        t12 = A.AssetRenderer_tryRenderFirst(t11);
      t10 = t10.size;
      t13 = _this.callMarket;
      t14 = _this.slippage;
      t15 = t13.get$bidPrice();
      t16 = t13._slippage$1(t14);
      t17 = _this.spotMarket;
      t13 = t17.toAsset$2(new A.Line(t9, t10 * (t13.get$bidPrice() + t13._slippage$1(t14))), t14);
      t18 = _this.putLeg;
      t19 = t18.asset;
      t20 = A.AssetRenderer_tryRenderFirst(t19);
      t18 = t18.size;
      t21 = _this.putMarket;
      t22 = t21.get$bidPrice();
      t23 = t21._slippage$1(t14);
      t14 = t17.toAsset$2(new A.Line(t9, t18 * (t21.get$bidPrice() + t21._slippage$1(t14))), t14);
      t21 = B.JSInt_methods._tdivFast$1(t1.difference$1(new A.DateTime(Date.now(), 0, false))._duration, 864e8);
      t1 = A.DateTimeAsExpirationExtension_get_formattedDate(t1);
      t17 = _this.__Straddle_distanceBetweenBreakEvens_F;
      t17 === $ && A.throwLateFieldNI("distanceBetweenBreakEvens");
      t24 = _this.__Straddle_breakEvenVsFullMoneyDown_F;
      t24 === $ && A.throwLateFieldNI("breakEvenVsFullMoneyDown");
      t25 = _this.__Straddle_breakEvenVsFullMoneyUp_F;
      t25 === $ && A.throwLateFieldNI("breakEvenVsFullMoneyUp");
      t26 = _this.__Straddle_breakEvenVsFullUnderlyingDown_F;
      t26 === $ && A.throwLateFieldNI("breakEvenVsFullUnderlyingDown");
      t27 = _this.__Straddle_breakEvenVsFullUnderlyingUp_F;
      t27 === $ && A.throwLateFieldNI("breakEvenVsFullUnderlyingUp");
      return A.LinkedHashMap_LinkedHashMap$_literal(["id", t2 + "~" + t5, "strategyType", "straddle", "strategyURL", t6, "underlying", t7.name, "underlyingURL", t8, "costInUnderlying", _this.costInUnderlying.size, "moneySize", _this.moneyLeg.size, "money", t9.name, "spotPrice", _this.spotPrice, "call", t11.name, "callURL", t12, "callSize", t10, "callCostInMoney", t10 * (t15 + t16), "callCostInUnderlying", t13.size, "put", t19.name, "putURL", t20, "putSize", t18, "putCostInMoney", t18 * (t22 + t23), "putCostInUnderlying", t14.size, "DTE", t21, "formattedDate", t1, "strikeAbsolute", t4, "strikeRelative", t3.relative, "distanceBetweenBreakEvensAbsolute", t17.absolute, "distanceBetweenBreakEvensRelative", t17.relative, "breakEvenVsFullMoneyDownAbsolute", t24.absolute, "breakEvenVsFullMoneyDownRelative", t24.relative, "breakEvenVsFullMoneyUpAbsolute", t25.absolute, "breakEvenVsFullMoneyUpRelative", t25.relative, "breakEvenVsFullUnderlyingDownAbsolute", t26.absolute, "breakEvenVsFullUnderlyingDownRelative", t26.relative, "breakEvenVsFullUnderlyingUpAbsolute", t27.absolute, "breakEvenVsFullUnderlyingUpRelative", t27.relative], type$.String, type$.dynamic);
    },
    toString$0(_) {
      return B.C_JsonCodec.encode$2$toEncodable(this, null);
    }
  };
  A.VerticalSpreadType.prototype = {
    _enumToString$0() {
      return "VerticalSpreadType." + this._name;
    }
  };
  A.VerticalSpread.prototype = {
    toJson$0() {
      var t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, _this = this, _null = null,
        t1 = _this.expiration,
        t2 = A._formatDate(t1),
        t3 = _this.shortOption,
        t4 = A._formatDouble(t3.strike),
        t5 = A._formatDouble(_this.longOption.strike);
      t3 = t3.isCall ? "call" : "put";
      t6 = A.PositionRenderer_tryRenderFirst(_this.strategy);
      t7 = _this.underlying;
      t8 = A.AssetRenderer_tryRenderFirst(t7);
      t9 = _this.shortLeg.asset;
      t10 = A.AssetRenderer_tryRenderFirst(t9);
      t11 = _this.longLeg.asset;
      t12 = A.AssetRenderer_tryRenderFirst(t11);
      t13 = _this.__VerticalSpread_type_F;
      t13 === $ && A.throwLateFieldNI("type");
      t14 = B.JSInt_methods._tdivFast$1(t1.difference$1(new A.DateTime(Date.now(), 0, false))._duration, 864e8);
      t1 = A.DateTimeAsExpirationExtension_get_formattedDate(t1);
      t15 = _this.__VerticalSpread_breakEvenVsFullMoney_F;
      t15 === $ && A.throwLateFieldNI("breakEvenVsFullMoney");
      t16 = t15 == null;
      t17 = t16 ? _null : t15.absolute;
      t15 = t16 ? _null : t15.relative;
      t16 = _this.__VerticalSpread_breakEvenVsFullUnderlying_F;
      t16 === $ && A.throwLateFieldNI("breakEvenVsFullUnderlying");
      t18 = t16 == null;
      t19 = t18 ? _null : t16.absolute;
      t16 = t18 ? _null : t16.relative;
      t18 = _this.__VerticalSpread_maxYield_F;
      t18 === $ && A.throwLateFieldNI("maxYield");
      t20 = _this.__VerticalSpread_maxYieldAt_F;
      t20 === $ && A.throwLateFieldNI("maxYieldAt");
      t21 = _this.__VerticalSpread_maxRisk_F;
      t21 === $ && A.throwLateFieldNI("maxRisk");
      t22 = _this.__VerticalSpread_maxRiskAt_F;
      t22 === $ && A.throwLateFieldNI("maxRiskAt");
      t23 = _this.__VerticalSpread_probability_F;
      t23 === $ && A.throwLateFieldNI("probability");
      return A.LinkedHashMap_LinkedHashMap$_literal(["id", t2 + "~" + t4 + "~" + t5 + "~" + t3, "strategyType", "verticalSpread", "strategyURL", t6, "underlying", t7.name, "underlyingURL", t8, "money", _this.money.name, "moneySize", _this.moneyLeg.size, "spotPrice", _this.spotPrice, "shortLeg", t9.name, "shortLegURL", t10, "longLeg", t11.name, "longLegURL", t12, "type", t13._name, "DTE", t14, "formattedDate", t1, "breakEvenVsFullMoneyAbsolute", t17, "breakEvenVsFullMoneyRelative", t15, "breakEvenVsFullUnderlyingAbsolute", t19, "breakEvenVsFullUnderlyingRelative", t16, "maxYield", t18, "maxYieldAtAbsolute", t20.absolute, "maxYieldAtRelative", t20.relative, "maxRisk", t21, "maxRiskAtAbsolute", t22.absolute, "maxRiskAtRelative", t22.relative, "probability", t23], type$.String, type$.dynamic);
    }
  };
  A.VerticalSpread_pickNearestBoundary_closure.prototype = {
    call$1(priceRange) {
      type$.PriceRange._as(priceRange);
      return A._setArrayType([priceRange.fromPrice, priceRange.toPrice], type$.JSArray_double);
    },
    $signature: 60
  };
  A.VerticalSpread_generateAll_closure.prototype = {
    call$1(ms) {
      return A.MarketsMapExtension_mapValues(A.MarketListExtension_groupByStrike(type$.Iterable_Market._as(ms), B.Order_0), new A.VerticalSpread_generateAll__closure(), type$.double, type$.Record_2_nullable_Market_call_and_nullable_Market_put);
    },
    $signature: 61
  };
  A.VerticalSpread_generateAll__closure.prototype = {
    call$1(ms) {
      var t1;
      type$.Iterable_Market._as(ms);
      t1 = type$.Market;
      return new A._Record_2_call_put(A.IterableExtensions_get_singleOrNull(A.MarketListExtension_get_calls(ms), t1), A.IterableExtensions_get_singleOrNull(A.MarketListExtension_get_puts(ms), t1));
    },
    $signature: 62
  };
  A.VerticalSpread_generateAll_makeSpread.prototype = {
    call$5(position, shortOption, longOption, shortMarket, longMarket) {
      var t8, t9, t10, width, cost, breakevenDouble, breakevenUnderlyingDouble, _this = this,
        t1 = _this.underlying,
        t2 = _this.money,
        t3 = _this.spotMarket,
        t4 = _this.spotPrice,
        t5 = A.PositionAnalyzer$(position, t2, t1),
        t6 = position._assetPositions,
        t7 = t6.$index(0, t2);
      t7.toString;
      t8 = new A.Line(t2, t7);
      t9 = t6.$index(0, shortOption);
      t9.toString;
      t6 = t6.$index(0, longOption);
      t6.toString;
      t6 = new A.VerticalSpread(t1, t2, _this.expiration, t5, shortOption, longOption, shortMarket, longMarket, position, new A.Line(shortOption, t9), new A.Line(longOption, t6), t8, t3, t4);
      t9 = longOption.strike;
      t10 = shortOption.strike;
      t6.__VerticalSpread_type_F = t9 < t10 ? B.VerticalSpreadType_0 : B.VerticalSpreadType_1;
      width = Math.abs(t10 - t9);
      cost = t7 < 0 ? -t7 : width - t7;
      t6.__VerticalSpread_probability_F = B.JSNumber_methods.clamp$2(width > 0 ? cost / width : 0, 0, 1);
      breakevenDouble = A.VerticalSpread_pickNearestBoundary(t4, t5.whereValueIs$1(0));
      t6.__VerticalSpread_breakEvenVsFullMoney_F = breakevenDouble != null ? new A.PriceInfo(breakevenDouble, breakevenDouble / t4) : null;
      t9 = type$.JSArray_Position;
      breakevenUnderlyingDouble = A.VerticalSpread_pickNearestBoundary(t4, A.PositionAnalyzer$(A._MergedPosition$(A._setArrayType([position, A._MergedPosition$(A._setArrayType([t8, t3.toAsset$1(new A.Line(t2, t7 * -1))], t9)).$negate(0)], t9)), t2, t1).whereValueIs$1(0));
      t6.__VerticalSpread_breakEvenVsFullUnderlying_F = breakevenUnderlyingDouble != null ? new A.PriceInfo(breakevenUnderlyingDouble, breakevenUnderlyingDouble / t4) : null;
      t6.__VerticalSpread_maxYield_F = 1 + Math.max(t5.get$maxValue(), 0) / Math.max(-t5.get$minValue(), 0);
      t1 = A.VerticalSpread_pickNearestBoundary(t4, t5.whereValueIs$1(t5.get$maxValue()));
      t1.toString;
      t6.__VerticalSpread_maxYieldAt_F = new A.PriceInfo(t1, t1 / t4);
      t6.__VerticalSpread_maxRisk_F = Math.max(-t5.get$minValue(), 0);
      t5 = A.VerticalSpread_pickNearestBoundary(t4, t5.whereValueIs$1(t5.get$minValue()));
      t5.toString;
      t6.__VerticalSpread_maxRiskAt_F = new A.PriceInfo(t5, t5 / t4);
      return t6;
    },
    $signature: 63
  };
  A.VerticalSpread_keepBestValidSpread_closure.prototype = {
    call$1(vs) {
      var t1 = type$.VerticalSpread._as(vs).__VerticalSpread_maxRisk_F;
      t1 === $ && A.throwLateFieldNI("maxRisk");
      return t1 > 0;
    },
    $signature: 26
  };
  A.VerticalSpread_keepBestValidSpread_closure0.prototype = {
    call$1(vs) {
      var t1 = type$.VerticalSpread._as(vs).__VerticalSpread_maxYield_F;
      t1 === $ && A.throwLateFieldNI("maxYield");
      return t1 > 1;
    },
    $signature: 26
  };
  A.VerticalSpread_keepBestValidSpread_closure1.prototype = {
    call$2(vs1, vs2) {
      var t1, t2,
        _s8_ = "maxYield";
      type$.nullable_VerticalSpread._as(vs1);
      type$.VerticalSpread._as(vs2);
      if (vs1 != null) {
        t1 = vs1.__VerticalSpread_maxYield_F;
        t1 === $ && A.throwLateFieldNI(_s8_);
        t2 = vs2.__VerticalSpread_maxYield_F;
  ...
  A.PriceInfo.prototype = {};
  A.Probabilities.prototype = {
    Probabilities$3$money$underlying(spreads, money, underlying) {
      var t2, t3, t4, t5, t6, entry, expiration, byStrike, rawProbs, strikeEntry, strike, vsOver, vsUnder, vsOver0, t7, t8, t9, t10, uOver, uUnder, wOver, wUnder, prob, sortedStrikes, monotonicProbs, previousProb, _i,
        _s11_ = "probability",
        _1000000000 = 1000000000,
        t1 = type$.List_VerticalSpread,
        byExpiration = A.LinkedHashMap_LinkedHashMap$_empty(type$.DateTime, t1);
      for (t2 = spreads.$ti, t3 = new A._SyncStarIterator(spreads._outerHelper(), t2._eval$1("_SyncStarIterator<1>")), t2 = t2._precomputed1; t3.moveNext$0();) {
        t4 = t3._async$_current;
        if (t4 == null)
          t4 = t2._as(t4);
        if (!t4.underlying.$eq(0, underlying) || !t4.money.$eq(0, money))
          continue;
        t5 = t4.shortMarket;
        t6 = true;
        if (!(t5.get$bidPrice() <= 0))
          if (!(t5.get$askPrice() <= 0)) {
            t5 = t4.longMarket;
            t5 = t5.get$bidPrice() <= 0 || t5.get$askPrice() <= 0;
          } else
            t5 = t6;
        else
          t5 = t6;
        if (t5)
          continue;
        J.add$1$ax(byExpiration.putIfAbsent$2(t4.expiration, new A.Probabilities_closure()), t4);
      }
      for (t2 = new A.LinkedHashMapEntriesIterable(byExpiration, byExpiration.$ti._eval$1("LinkedHashMapEntriesIterable<1,2>")).get$iterator(0), t3 = this._probs, t4 = type$.double; t2.moveNext$0();) {
        entry = t2.__js_helper$_current;
        expiration = entry.key;
        byStrike = A.LinkedHashMap_LinkedHashMap$_empty(t4, t1);
        for (t5 = J.get$iterator$ax(entry.value); t5.moveNext$0();) {
          t6 = t5.get$current();
          J.add$1$ax(byStrike.putIfAbsent$2(t6.shortOption.strike, new A.Probabilities_closure0()), t6);
        }
        rawProbs = A.LinkedHashMap_LinkedHashMap$_empty(t4, t4);
        for (t5 = new A.LinkedHashMapEntryIterator(byStrike, byStrike._modifications, byStrike._first, byStrike.$ti._eval$1("LinkedHashMapEntryIterator<1,2>")); t5.moveNext$0();) {
          strikeEntry = t5.__js_helper$_current;
          strike = strikeEntry.key;
          for (t6 = J.get$iterator$ax(strikeEntry.value), vsOver = null, vsUnder = null; t6.moveNext$0();) {
            vsOver0 = t6.get$current();
            t7 = vsOver0.__VerticalSpread_type_F;
            t7 === $ && A.throwLateFieldNI("type");
            if (t7 === B.VerticalSpreadType_0)
              vsOver = vsOver0;
            else if (t7 === B.VerticalSpreadType_1)
              vsUnder = vsOver0;
          }
          t6 = vsOver != null;
          if (t6 && vsUnder != null) {
            t6 = vsOver.__VerticalSpread_probability_F;
            t6 === $ && A.throwLateFieldNI(_s11_);
            t7 = vsUnder.__VerticalSpread_probability_F;
            t7 === $ && A.throwLateFieldNI(_s11_);
            t8 = vsOver.shortMarket;
            t9 = t8.get$askPrice();
            t8 = t8.get$bidPrice();
            t10 = vsOver.longMarket;
            uOver = t9 - t8 + (t10.get$askPrice() - t10.get$bidPrice());
            t10 = vsUnder.shortMarket;
            t8 = t10.get$askPrice();
            t10 = t10.get$bidPrice();
            t9 = vsUnder.longMarket;
            uUnder = t8 - t10 + (t9.get$askPrice() - t9.get$bidPrice());
            wOver = uOver <= 0 ? _1000000000 : 1 / uOver;
            wUnder = uUnder <= 0 ? _1000000000 : 1 / uUnder;
            prob = (t6 * wOver + (1 - t7) * wUnder) / (wOver + wUnder);
          } else if (t6) {
            t6 = vsOver.__VerticalSpread_probability_F;
            t6 === $ && A.throwLateFieldNI(_s11_);
            prob = t6;
          } else if (vsUnder != null) {
            t6 = vsUnder.__VerticalSpread_probability_F;
            t6 === $ && A.throwLateFieldNI(_s11_);
            prob = 1 - t6;
          } else
            continue;
          rawProbs.$indexSet(0, strike, prob);
        }
        t5 = rawProbs.$ti._eval$1("LinkedHashMapKeysIterable<1>");
        sortedStrikes = A.List_List$_of(new A.LinkedHashMapKeysIterable(rawProbs, t5), t5._eval$1("Iterable.E"));
        B.JSArray_methods.sort$1(sortedStrikes, new A.Probabilities_closure1());
        monotonicProbs = A.LinkedHashMap_LinkedHashMap$_empty(t4, t4);
        for (t5 = sortedStrikes.length, previousProb = null, _i = 0; _i < sortedStrikes.length; sortedStrikes.length === t5 || (0, A.throwConcurrentModificationError)(sortedStrikes), ++_i) {
          strike = sortedStrikes[_i];
          t6 = rawProbs.$index(0, strike);
          t6.toString;
          if (previousProb == null) {
            monotonicProbs.$indexSet(0, strike, t6);
            previousProb = t6;
          } else if (t6 >= previousProb) {
            monotonicProbs.$indexSet(0, strike, t6);
            previousProb = t6;
          }
        }
        t3.$indexSet(0, expiration, monotonicProbs);
      }
    },
    getProbability$2(expiration, strike) {
      var t1, strikes, i, t2, kLower, kUpper,
        expProbs = this._probs.$index(0, expiration);
      if (expProbs == null || expProbs.__js_helper$_length === 0)
        throw A.wrapException(A.ArgumentError$("No probability distribution found for expiration " + expiration.toString$0(0), null));
      t1 = A._instanceType(expProbs)._eval$1("LinkedHashMapKeysIterable<1>");
      strikes = A.List_List$_of(new A.LinkedHashMapKeysIterable(expProbs, t1), t1._eval$1("Iterable.E"));
      B.JSArray_methods.sort$0(strikes);
      if (strike < B.JSArray_methods.get$first(strikes) || strike > B.JSArray_methods.get$last(strikes))
        throw A.wrapException(A.ArgumentError$("Extrapolation is not allowed. Strike " + A.S(strike) + " is outside the known range [" + A.S(B.JSArray_methods.get$first(strikes)) + ", " + A.S(B.JSArray_methods.get$last(strikes)) + "]", null));
      if (expProbs.containsKey$1(strike)) {
        t1 = expProbs.$index(0, strike);
        t1.toString;
        return t1;
      }
      t1 = strikes.length;
      i = 0;
      for (;;) {
        if (!(i < t1 && strikes[i] < strike))
          break;
        ++i;
      }
      t2 = i - 1;
      if (!(t2 >= 0 && t2 < t1))
        return A.ioore(strikes, t2);
      kLower = strikes[t2];
      if (!(i < t1))
        return A.ioore(strikes, i);
      kUpper = strikes[i];
      t1 = expProbs.$index(0, kLower);
      t1.toString;
      t2 = expProbs.$index(0, kUpper);
      t2.toString;
      return t1 + (strike - kLower) / (kUpper - kLower) * (t2 - t1);
    }
  };
  A.Probabilities_closure.prototype = {
    call$0() {
      return A._setArrayType([], type$.JSArray_VerticalSpread);
    },
    $signature: 27
  };
  A.Probabilities_closure0.prototype = {
    call$0() {
      return A._setArrayType([], type$.JSArray_VerticalSpread);
    },
    $signature: 27
  };
  A.Probabilities_closure1.prototype = {
    call$2(a, b) {
      A._asDouble(a);
  ...
  A.deribitMarkets_closure.prototype = {
    call$2(instr, error) {
    },
    $signature: 68
  };
  A.deribitLongOptions_closure.prototype = {
    call$1(e) {
      return type$.LongCall._as(e).toJson$0();
    },
    $signature: 28
  };
  A.deribitLongOptions_closure0.prototype = {
    call$1(e) {
      return type$.LongPut._as(e).toJson$0();
    },
    $signature: 29
  };
  A.yfinanceLongOptions_closure.prototype = {
    call$1(e) {
      return type$.LongCall._as(e).toJson$0();
    },
    $signature: 28
  };
  A.yfinanceLongOptions_closure0.prototype = {
    call$1(e) {
      return type$.LongPut._as(e).toJson$0();
    },
    $signature: 29
  };
  A.setupJsInterop_closure.prototype = {
    call$4(ticker, slippage, minDTE, maxDTE) {
      var t1;
      A._asString(ticker);
      A._asDouble(slippage);
      A._asDouble(minDTE);
      A._asDouble(maxDTE);
      t1 = type$.String;
      return A.FutureOfJSAnyToJSPromise_get_toJS(A.deribitCoveredCalls(ticker, slippage, A._asInt(minDTE), A._asInt(maxDTE)).then$1$1(new A.setupJsInterop__closure5(), t1), t1);
    },
    $signature: 3
  };
  A.setupJsInterop__closure5.prototype = {
    call$1(value) {
      return A._asString(value);
    },
    $signature: 1
  };
  A.setupJsInterop_closure0.prototype = {
    call$4(ticker, slippage, minDTE, maxDTE) {
      var t1;
      A._asString(ticker);
      A._asDouble(slippage);
      ...
      A._asDouble(maxDTE);
      t1 = type$.String;
      return A.FutureOfJSAnyToJSPromise_get_toJS(A.deribitVerticalSpreads(ticker, slippage, A._asInt(minDTE), A._asInt(maxDTE)).then$1$1(new A.setupJsInterop__closure4(), t1), t1);
    },
    $signature: 3
  };
  A.setupJsInterop__closure4.prototype = {
    call$1(value) {
      return A._asString(value);
    },
    $signature: 1
  };
  A.setupJsInterop_closure1.prototype = {
    call$4(ticker, slippage, minDTE, maxDTE) {
      var t1;
      A._asString(ticker);
      A._asDouble(slippage);
      ...
      A._asDouble(maxDTE);
      t1 = type$.String;
      return A.FutureOfJSAnyToJSPromise_get_toJS(A.yfinanceCoveredCalls(ticker, slippage, A._asInt(minDTE), A._asInt(maxDTE)).then$1$1(new A.setupJsInterop__closure3(), t1), t1);
    },
    $signature: 3
  };
  A.setupJsInterop__closure3.prototype = {
    call$1(value) {
      return A._asString(value);
    },
    $signature: 1
  };
  A.setupJsInterop_closure2.prototype = {
    call$4(ticker, slippage, minDTE, maxDTE) {
      var t1;
      A._asString(ticker);
      A._asDouble(slippage);
      ...
      A._asDouble(maxDTE);
      t1 = type$.String;
      return A.FutureOfJSAnyToJSPromise_get_toJS(A.deribitLongOptions(ticker, slippage, A._asInt(minDTE), A._asInt(maxDTE)).then$1$1(new A.setupJsInterop__closure2(), t1), t1);
    },
    $signature: 3
  };
  A.setupJsInterop__closure2.prototype = {
    call$1(value) {
      return A._asString(value);
    },
    $signature: 1
  };
  A.setupJsInterop_closure3.prototype = {
    call$4(ticker, slippage, minDTE, maxDTE) {
      var t1;
      A._asString(ticker);
      A._asDouble(slippage);
      ...
      A._asDouble(maxDTE);
      t1 = type$.String;
      return A.FutureOfJSAnyToJSPromise_get_toJS(A.yfinanceLongOptions(ticker, slippage, A._asInt(minDTE), A._asInt(maxDTE)).then$1$1(new A.setupJsInterop__closure1(), t1), t1);
    },
    $signature: 3
  };
  A.setupJsInterop__closure1.prototype = {
    call$1(value) {
      return A._asString(value);
    },
    $signature: 1
  };
  A.setupJsInterop_closure4.prototype = {
    call$4(ticker, slippage, minDTE, maxDTE) {
      var t1;
      A._asString(ticker);
      A._asDouble(slippage);
      ...
      A._asDouble(maxDTE);
      t1 = type$.String;
      return A.FutureOfJSAnyToJSPromise_get_toJS(A.deribitStraddles(ticker, slippage, A._asInt(minDTE), A._asInt(maxDTE)).then$1$1(new A.setupJsInterop__closure0(), t1), t1);
    },
    $signature: 3
  };
  A.setupJsInterop__closure0.prototype = {
    call$1(value) {
      return A._asString(value);
    },
    $signature: 1
  };
  A.setupJsInterop_closure5.prototype = {
    call$4(ticker, slippage, minDTE, maxDTE) {
      var t1;
      A._asString(ticker);
      A._asDouble(slippage);
      ...
      A._asDouble(maxDTE);
      t1 = type$.String;
      return A.FutureOfJSAnyToJSPromise_get_toJS(A.yfinanceStraddles(ticker, slippage, A._asInt(minDTE), A._asInt(maxDTE)).then$1$1(new A.setupJsInterop__closure(), t1), t1);
    },
    $signature: 3
  };
  A.setupJsInterop__closure.prototype = {
    call$1(value) {
      return A._asString(value);
    },
    $signature: 1
  ...
  (function installTearOffs() {
    ...
    _static_2(J, "_interceptors_JSArray__compareAny$closure", "JSArray__compareAny", 9);
    _instance_1_u(A.CastStreamSubscription.prototype, "get$__internal$_onData", "__internal$_onData$1", 20);
    ...
    _static_2(A, "collection_ListBase__compareAny$closure", "ListBase__compareAny", 9);
    _static_2(A, "collection___dynamicCompare$closure", "_dynamicCompare", 9);
    _instance(A._HashSet.prototype, "get$_newSimilarSet", 0, 0, null, ["call$1$0", "call$0"], ["_newSimilarSet$1$0", "_newSimilarSet$0"], 7, 0, 0);
    _instance(A._LinkedHashSet.prototype, "get$_newSimilarSet", 0, 0, null, ["call$1$0", "call$0"], ["_newSimilarSet$1$0", "_newSimilarSet$0"], 7, 0, 0);
    _instance(A.SplayTreeSet.prototype, "get$_newSet", 0, 0, null, ["call$1$0", "call$0"], ["_newSet$1$0", "_newSet$0"], 7, 0, 0);
    ...
    _static_2(A, "core_Comparable_compare$closure", "Comparable_compare", 88);
    _static_1(A, "core_Uri_decodeComponent$closure", "Uri_decodeComponent", 1);
    _static_1(A, "case_insensitive_map_CaseInsensitiveMap__canonicalizer$closure", "CaseInsensitiveMap__canonicalizer", 1);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Stream, A.CastStreamSubscription, A.Iterable, A.CastIterator, A.Closure, A.Error, A.ListBase, A.SentinelValue, A.ListIterator, A.MappedIterator, A.WhereIterator, A.ExpandIterator, A.SkipIterator, A.EmptyIterator, A.FollowedByIterator, A.WhereTypeIterator, A.NonNullsIterator, A.IndexedIterator, A.FixedLengthListMixin, A.UnmodifiableListMixin, A.Symbol, A._Record, A.ConstantMap, A._KeysOrValuesOrElementsIterator, A.SetBase, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapValueIterator, A.LinkedHashMapEntryIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._AllMatchesIterator, A.StringMatch, A._StringAllMatchesIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A._SyncStarIterator, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamController, A._AsyncStreamControllerDispatch, A._BufferingStreamSubscription, A._DelayedEvent, A._DelayedDone, A._PendingEvents, A._DoneStreamSubscription, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A._HashSetIterator, A._LinkedHashSetCell, A._LinkedHashSetIterator, A._UnmodifiableMapMixin, A.MapView, A._SplayTreeNode, A._SplayTree, A._SplayTreeIterator, A.Codec, A.Converter, A.ByteConversionSink, A._JsonStringifier, A._Utf8Encoder, A._Utf8Decoder, A.DateTime, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A._Uri, A.UriData, A._SimpleUri, A.NullRejectionException, A.CanonicalizedMap, A.ClientException, A.BaseClient, A.BaseRequest, A.BaseResponse, A.MediaType, A.MemoryCache, A.CacheItem, A.Asset, A.Position, A.ListedInstrument, A.UrlFetcher, A.YFinance, A.Market, A.Oracle, A.PositionAnalyzer, A.PriceRange, A._PnLSegment, A._OptionStratAssetRenderer, A._DeribitAssetRenderer, A._OptionStratPositionRenderer, A.CoveredCall, A.LongCall, A.LongPut, A.Straddle, A.VerticalSpread, A.PriceInfo, A.Probabilities, A.Context, A.Style, A.ParsedPath, A.PathException, A.SourceFile, A.SourceLocationMixin, A.SourceSpanMixin, A.Highlighter, A._Highlight, A._Line, A.SourceLocation, A.SourceSpanException, A.StringScanner]);
    ...
    _inheritMany(A.Stream, [A.CastStream, A.StreamView, A._StreamImpl, A._EmptyStream, A._MultiStream]);
    _inheritMany(A.Iterable, [A._CastIterableBase, A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A.ExpandIterable, A.SkipIterable, A.FollowedByIterable, A.WhereTypeIterable, A.NonNullsIterable, A.IndexedIterable, A._KeysOrValues, A._AllMatchesIterable, A._StringAllMatchesIterable, A._SyncStarIterable]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.Instantiation, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A.Stream_toSet_closure, A._LinkedCustomHashMap_closure, A.MapBase_entries_closure, A.FutureOfJSAnyToJSPromise_get_toJS__closure, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.CanonicalizedMap_entries_closure, A.CanonicalizedMap_keys_closure, A.get_closure, A.BaseRequest_closure0, A.BrowserClient_send_closure, A._bodyToStream_closure, A.ByteStream_toBytes_closure, A.MediaType_toString__closure, A.expectQuotedString_closure, A.Position_operator$index_closure, A._ScaledPosition_decompose_closure, A._MergedPosition_closure, A._MergedPosition_closure0, A.Deribit_fetchMarkets_closure, A.Deribit_fetchMarkets__closure, A.Deribit_fetchMarkets__closure0, A.Deribit_fetchMarkets_closure0, A.ListedInstrumentDeribitUtils_toMarket_makeMarket, A.MarketListExtension_whereUnderlyingIs_closure, A.MarketListExtension_coercedToMoney_closure, A.MarketListExtension_optionsWithStrikeInMoney_closure, A.MarketListExtension_get_calls_closure, A.MarketListExtension_get_puts_closure, A.MarketListExtension_sortByExpiration_closure, A.MarketListExtension_sortByStrike_closure, A.MarketListExtension__sort_closure, A.MarketListExtension__sort_closure1, A.MarketListExtension_groupByExpiration_closure, A.MarketListExtension_groupByStrike_closure, A.MarketListExtension__groupBy_closure, A.MarketListExtension__groupBy_closure0, A.Market_toString_closure, A.Market_toString_closure0, A.Oracle_markToMarket_closure, A.Oracle_intrinsicValue_closure, A.Oracle_intrinsicValue_closure0, A.PositionAnalyzer_priceToValue, A.PositionAnalyzer_minValue_closure, A.PositionAnalyzer_maxValue_closure, A.PositionAnalyzer_whereValueIs_closure, A.PositionRenderer_tryRenderFirst_closure, A.VerticalSpread_pickNearestBoundary_closure, A.VerticalSpread_generateAll_closure, A.VerticalSpread_generateAll__closure, A.VerticalSpread_generateAll_makeSpread, A.VerticalSpread_keepBestValidSpread_closure, A.VerticalSpread_keepBestValidSpread_closure0, A.deribitLongOptions_closure, A.deribitLongOptions_closure0, A.yfinanceLongOptions_closure, A.yfinanceLongOptions_closure0, A.setupJsInterop_closure, A.setupJsInterop__closure5, A.setupJsInterop_closure0, A.setupJsInterop__closure4, A.setupJsInterop_closure1, A.setupJsInterop__closure3, A.setupJsInterop_closure2, A.setupJsInterop__closure2, A.setupJsInterop_closure3, A.setupJsInterop__closure1, A.setupJsInterop_closure4, A.setupJsInterop__closure0, A.setupJsInterop_closure5, A.setupJsInterop__closure, A.Context_joinAll_closure, A.Context_split_closure, A._validateArgList_closure, A.Highlighter$__closure, A.Highlighter$___closure, A.Highlighter$__closure0, A.Highlighter__collateLines_closure, A.Highlighter__collateLines_closure1, A.Highlighter__collateLines__closure, A.Highlighter_highlight_closure]);
    _inheritMany(A.Closure2Args, [A._CastListBase_sort_closure, A.JsLinkedHashMap_addAll_closure, A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure0, A.LinkedHashMap_LinkedHashMap$from_closure, A.MapBase_mapToString_closure, A.SplayTreeSet__newSet_closure, A._JsonStringifier_writeMap_closure, A._Uri__makeQueryFromParameters_closure, A.Uri_splitQueryString_closure, A.Uri_parseIPv6Address_error, A._Uri__makeQueryFromParametersDefault_writeParameter, A._Uri__makeQueryFromParametersDefault_closure, A.FutureOfJSAnyToJSPromise_get_toJS_closure, A.FutureOfJSAnyToJSPromise_get_toJS__closure0, A.CanonicalizedMap_addAll_closure, A.CanonicalizedMap_forEach_closure, A.BaseRequest_closure, A.MediaType_toString_closure, A.MarketListExtension__sort_closure0, A.MarketsMapExtension_mapValues_closure, A._RealMarketsOracle_marketFor_closure, A.PriceRange__mergeAdjacents_closure, A.VerticalSpread_keepBestValidSpread_closure1, A.Probabilities_closure1, A.deribitMarkets_closure, A.Highlighter__collateLines_closure0]);
    ...
    _inheritMany(A._Record2, [A._Record_2, A._Record_2_call_put]);
    ...
    _inheritMany(A._Enum, [A.Venue, A.Order, A.VerticalSpreadType]);
    _inheritMany(A.Position, [A.Line, A._ScaledPosition, A._MergedPosition]);
    _inheritMany(A.Asset, [A.Commodity, A.Expirable]);
    _inheritMany(A.Expirable, [A.DatedFuture, A.Option]);
    _inheritMany(A.Market, [A._DirectMarket, A._InverseMarket, A._SyntheticMarket]);
    _inherit(A._IdentityMarket, A._DirectMarket);
    _inheritMany(A.Oracle, [A.ArchOracle, A.SimulatedOracle]);
    _inherit(A._RealMarketsOracle, A.ArchOracle);
  ...
  var string$ = {
    ...
    Bid_pr: "Bid price cannot be greater than ask price! ",
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_Market: findType("JSArray<Market>"),
      JSArray_Object: findType("JSArray<Object>"),
      JSArray_Position: findType("JSArray<Position>"),
      JSArray_PriceRange: findType("JSArray<PriceRange>"),
      JSArray_String: findType("JSArray<String>"),
      JSArray_VerticalSpread: findType("JSArray<VerticalSpread>"),
      JSArray__Highlight: findType("JSArray<_Highlight>"),
      JSArray__Line: findType("JSArray<_Line>"),
      JSArray__PnLSegment: findType("JSArray<_PnLSegment>"),
      JSArray_double: findType("JSArray<double>"),
      JSArray_dynamic: findType("JSArray<@>"),
      JSArray_int: findType("JSArray<int>"),
      JSArray_nullable_String: findType("JSArray<String?>"),
      JSArray_nullable_VerticalSpread: findType("JSArray<VerticalSpread?>"),
      ...
      Line: findType("Line"),
      List_Market: findType("List<Market>"),
      List_PriceRange: findType("List<PriceRange>"),
      List_String: findType("List<String>"),
      List_VerticalSpread: findType("List<VerticalSpread>"),
      List_dynamic: findType("List<@>"),
      List_int: findType("List<int>"),
      List_nullable__Highlight: findType("List<_Highlight?>"),
      ListedInstrument: findType("ListedInstrument"),
      LongCall: findType("LongCall"),
      LongPut: findType("LongPut"),
      ...
      Map_Asset_Market: findType("Map<Asset,Market>"),
      Map_String_String: findType("Map<String,String>"),
      Map_String_dynamic: findType("Map<String,@>"),
      Map_double_double: findType("Map<double,double>"),
      Map_dynamic_dynamic: findType("Map<@,@>"),
      Map_of_double_and_Record_2_nullable_Market_call_and_nullable_Market_put: findType("Map<double,+call,put(Market?,Market?)>"),
      MappedListIterable_Line_Position: findType("MappedListIterable<Line,Position>"),
      MappedListIterable_String_dynamic: findType("MappedListIterable<String,@>"),
      Market: findType("Market"),
      MediaType: findType("MediaType"),
      MultiStreamController_List_int: findType("MultiStreamController<List<int>>"),
      NativeTypedArrayOfInt: findType("NativeTypedArrayOfInt"),
      NativeUint8List: findType("NativeUint8List"),
      NonNullsIterable_Market: findType("NonNullsIterable<Market>"),
      NonNullsIterable_PriceRange: findType("NonNullsIterable<PriceRange>"),
      NonNullsIterable_VerticalSpread: findType("NonNullsIterable<VerticalSpread>"),
      Null: findType("Null"),
      Object: findType("Object"),
      Option: findType("Option"),
      Position: findType("Position"),
      Position_Function_Line: findType("Position(Line)"),
      PriceRange: findType("PriceRange"),
      Record: findType("Record"),
      Record_0: findType("+()"),
      Record_2_Asset_and_Asset: findType("+(Asset,Asset)"),
      Record_2_Asset_and_Commodity: findType("+(Asset,Commodity)"),
      Record_2_int_and_Market: findType("+(int,Market)"),
      Record_2_nullable_Market_call_and_nullable_Market_put: findType("+call,put(Market?,Market?)"),
      ...
      Uri: findType("Uri"),
      Venue: findType("Venue"),
      VerticalSpread: findType("VerticalSpread"),
      WhereTypeIterable_String: findType("WhereTypeIterable<String>"),
      YFinance: findType("YFinance"),
      ...
      _PnLSegment: findType("_PnLSegment"),
      _StreamControllerAddStreamState_nullable_Object: findType("_StreamControllerAddStreamState<Object?>"),
      _SyncStarIterable_CoveredCall: findType("_SyncStarIterable<CoveredCall>"),
      _SyncStarIterable_Line: findType("_SyncStarIterable<Line>"),
      _SyncStarIterable_ListedInstrument: findType("_SyncStarIterable<ListedInstrument>"),
      _SyncStarIterable_LongCall: findType("_SyncStarIterable<LongCall>"),
      _SyncStarIterable_LongPut: findType("_SyncStarIterable<LongPut>"),
      _SyncStarIterable_Straddle: findType("_SyncStarIterable<Straddle>"),
      _SyncStarIterable_VerticalSpread: findType("_SyncStarIterable<VerticalSpread>"),
      bool: findType("bool"),
      ...
      nullable_ListedInstrument: findType("ListedInstrument?"),
      nullable_Map_String_String: findType("Map<String,String>?"),
      nullable_Market: findType("Market?"),
      nullable_Object: findType("Object?"),
      nullable_StackTrace: findType("StackTrace?"),
      nullable_String: findType("String?"),
      nullable_String_Function_Match: findType("String(Match)?"),
      nullable_VerticalSpread: findType("VerticalSpread?"),
...
;
    ...
    B.List_jTS = makeConstList(["", "JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC"], type$.JSArray_String);
    ...
    B.Order_0 = new A.Order(0, "asc");
    B.Order_1 = new A.Order(1, "desc");
    B.Record2_calls_true = new A._Record_2("calls", true);
    B.Record2_puts_false = new A._Record_2("puts", false);
    B.Venue_1 = new A.Venue(1, "OptionStrat");
    B.Set_4AiM = new A.GeneralConstantSet([B.Venue_1], type$.GeneralConstantSet_Venue);
    B.Venue_0 = new A.Venue(0, "Deribit");
    B.Set_G4DT2 = new A.GeneralConstantSet([B.Venue_0], type$.GeneralConstantSet_Venue);
    B.Set_empty = new A.ConstantStringSet(B.Object_empty, 0, A.findType("ConstantStringSet<Venue>"));
    ...
    B.VerticalSpreadType_0 = new A.VerticalSpreadType(0, "over");
    B.VerticalSpreadType_1 = new A.VerticalSpreadType(1, "under");
  })();
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "ListedInstrumentDeribitUtils__instrumentRegex", "$get$ListedInstrumentDeribitUtils__instrumentRegex", () => A.RegExp_RegExp("^([\\w_]+)(?:-([\\w_]+))??(?:-((?:\\d+[A-Z]+\\d+)|_)+)?(?:-([\\d_]+))?(?:-(P|C))?$"));
    _lazyFinal($, "ListedInstrumentDeribitUtils__dateRegex", "$get$ListedInstrumentDeribitUtils__dateRegex", () => A.RegExp_RegExp("^(\\d+)(\\w*?)(\\d+)$"));
    _lazyFinal($, "ListedInstrumentDeribitUtils__monthToNum", "$get$ListedInstrumentDeribitUtils__monthToNum", () => A.LinkedHashMap_LinkedHashMap$_literal(["JAN", 1, "FEB", 2, "MAR", 3, "APR", 4, "MAY", 5, "JUN", 6, "JUL", 7, "AUG", 8, "SEP", 9, "OCT", 10, "NOV", 11, "DEC", 12], type$.String, type$.int));
    _lazy($, "_urlFetcher", "$get$_urlFetcher", () => new A.UrlFetcher(new A.MemoryCache(A.LinkedHashMap_LinkedHashMap$_empty(type$.String, A.findType("CacheItem<@>"))), A.Duration$(0, 0, 5)));
